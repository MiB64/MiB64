...
void CompileReadTLBMiss (BLOCK_SECTION * Section, int AddressReg, int LookUpReg ) {
	MoveX86regToVariable(&RecompPos, AddressReg,&TLBLoadAddress,"TLBLoadAddress");
	TestX86RegToX86Reg(&RecompPos, LookUpReg,LookUpReg);
		...
		if (EffectDelaySlot) { 
			...
			if (FallInfo->FallThrough && !FallInfo->DoneDelaySlot) {
				...
				if (!JumpInfo->DoneDelaySlot) {
					...
					JmpLabel32(&RecompPos,FallInfo->BranchLabel,0);
	...
	if ( NextInstruction == NORMAL ) {		
		...
		if (Section->Cont.FallThrough)  {
			...
			if ((Section->CompilePC & 0xFFC) == 0xFFC) {
				...
				JmpLabel32(&RecompPos,"DoDelaySlot",0);
...
void BNE_Compare (BLOCK_SECTION * Section) {
	...
	if (IsKnown(Opcode.BRANCH.rs) && IsKnown(Opcode.BRANCH.rt)) {
		if (IsConst(Opcode.BRANCH.rs) && IsConst(Opcode.BRANCH.rt)) {
			...
			if (Is64Bit(Opcode.BRANCH.rs) || Is64Bit(Opcode.BRANCH.rt)) {
				...
				if (Section->Jump.FallThrough) {
					JneLabel8(&RecompPos,"continue",0);
					Jump = RecompPos - 1;
				} else {
					JneLabel32(&RecompPos,Section->Jump.BranchLabel,0);
					Section->Jump.LinkLocation = RecompPos - 4;
				}
				CompX86RegToX86Reg(&RecompPos,MipsRegLo(Opcode.BRANCH.rs),MipsRegLo(Opcode.BRANCH.rt));
				if (Section->Cont.FallThrough) {
					JneLabel32 ( &RecompPos, Section->Jump.BranchLabel, 0 );
					Section->Jump.LinkLocation2 = RecompPos - 4;
				} else if (Section->Jump.FallThrough) {
					JeLabel32 ( &RecompPos, Section->Cont.BranchLabel, 0 );
					...
					JeLabel32 ( &RecompPos, Section->Cont.BranchLabel, 0 );
					Section->Cont.LinkLocation = RecompPos - 4;
					JmpLabel32(&RecompPos,Section->Jump.BranchLabel,0);
					Section->Jump.LinkLocation2 = RecompPos - 4;
				}
			} else {
				CompX86RegToX86Reg(&RecompPos,MipsRegLo(Opcode.BRANCH.rs),MipsRegLo(Opcode.BRANCH.rt));
			...
			if (Is64Bit(ConstReg) || Is64Bit(MappedReg)) {
				if (Is32Bit(ConstReg) || Is32Bit(MappedReg)) {
					...
					if (Is32Bit(MappedReg)) {
						CompConstToX86reg(&RecompPos,Map_TempReg(Section,x86_Any,MappedReg,TRUE),MipsRegHi(ConstReg));
					} else {
						CompConstToX86reg(&RecompPos,MipsRegHi(MappedReg),(int)MipsRegLo(ConstReg) >> 31);
					}
				} else {
					CompConstToX86reg(&RecompPos,MipsRegHi(MappedReg),MipsRegHi(ConstReg));
				}
				if (Section->Jump.FallThrough) {
					JneLabel8(&RecompPos,"continue",0);
					Jump = RecompPos - 1;
				...
				if (MipsRegLo(ConstReg) == 0) {
					OrX86RegToX86Reg(&RecompPos, MipsRegLo(MappedReg),MipsRegLo(MappedReg));
				} else {
					CompConstToX86reg(&RecompPos,MipsRegLo(MappedReg),MipsRegLo(ConstReg));
				}
				if (Section->Cont.FallThrough) {
					JneLabel32 ( &RecompPos, Section->Jump.BranchLabel, 0 );
					Section->Jump.LinkLocation2 = RecompPos - 4;
		...
		if (IsConst(KnownReg)) {
			if (Is64Bit(KnownReg)) {
				CompConstToVariable(&RecompPos,MipsRegHi(KnownReg),&GPR[UnknownReg].W[1],GPR_NameHi[UnknownReg]);
			} else if (IsSigned(KnownReg)) {
				CompConstToVariable(&RecompPos,((int)MipsRegLo(KnownReg) >> 31),&GPR[UnknownReg].W[1],GPR_NameHi[UnknownReg]);
			} else {
				CompConstToVariable(&RecompPos,0,&GPR[UnknownReg].W[1],GPR_NameHi[UnknownReg]);
			}
		} else {
			if (Is64Bit(KnownReg)) {
				CompX86regToVariable(&RecompPos,MipsRegHi(KnownReg),&GPR[UnknownReg].W[1],GPR_NameHi[UnknownReg]);
			} else if (IsSigned(KnownReg)) {
				ProtectGPR(Section,KnownReg);
				CompX86regToVariable(&RecompPos,Map_TempReg(Section,x86_Any,KnownReg,TRUE),&GPR[UnknownReg].W[1],GPR_NameHi[UnknownReg]);
			} else {
				CompConstToVariable(&RecompPos,0,&GPR[UnknownReg].W[1],GPR_NameHi[UnknownReg]);
			}
		}
		...
		if (IsConst(KnownReg)) {
			CompConstToVariable(&RecompPos,MipsRegLo(KnownReg),&GPR[UnknownReg].W[0],GPR_NameLo[UnknownReg]);
		} else {
			CompX86regToVariable(&RecompPos,MipsRegLo(KnownReg),&GPR[UnknownReg].W[0],GPR_NameLo[UnknownReg]);
		}
		if (Section->Cont.FallThrough) {
			JneLabel32 ( &RecompPos, Section->Jump.BranchLabel, 0 );
			Section->Jump.LinkLocation2 = RecompPos - 4;
		...
		CompX86regToVariable(&RecompPos,x86Reg,&GPR[Opcode.BRANCH.rs].W[1],GPR_NameHi[Opcode.BRANCH.rs]);
		if (Section->Jump.FallThrough) {
			JneLabel8(&RecompPos,"continue",0);
			Jump = RecompPos - 1;
		} else {
		...
		CompX86regToVariable(&RecompPos,x86Reg,&GPR[Opcode.BRANCH.rs].W[0],GPR_NameLo[Opcode.BRANCH.rs]);
		if (Section->Cont.FallThrough) {
			JneLabel32 ( &RecompPos, Section->Jump.BranchLabel, 0 );
			Section->Jump.LinkLocation2 = RecompPos - 4;
		} else if (Section->Jump.FallThrough) {
...
void BEQ_Compare (BLOCK_SECTION * Section) {
	...
	if (IsKnown(Opcode.BRANCH.rs) && IsKnown(Opcode.BRANCH.rt)) {
		if (IsConst(Opcode.BRANCH.rs) && IsConst(Opcode.BRANCH.rt)) {
			...
			if (Is64Bit(Opcode.BRANCH.rs) || Is64Bit(Opcode.BRANCH.rt)) {
				...
				if (Section->Cont.FallThrough) {
					...
					JneLabel32(&RecompPos,Section->Cont.BranchLabel,0);
					Section->Cont.LinkLocation = RecompPos - 4;
				}
				CompX86RegToX86Reg(&RecompPos,MipsRegLo(Opcode.BRANCH.rs),MipsRegLo(Opcode.BRANCH.rt));
				if (Section->Cont.FallThrough) {
					JeLabel32 ( &RecompPos, Section->Jump.BranchLabel, 0 );
					Section->Jump.LinkLocation = RecompPos - 4;
					CPU_Message("      ");
					CPU_Message("      continue:");
					SetJump8(Jump,RecompPos);
		...
		CompX86regToVariable(&RecompPos,x86Reg,&GPR[Opcode.BRANCH.rt].W[1],GPR_NameHi[Opcode.BRANCH.rt]);
		if (Section->Cont.FallThrough) {
			JneLabel8(&RecompPos,"continue",0);
			Jump = RecompPos - 1;
		} else {
		...
		CompX86regToVariable(&RecompPos,Map_TempReg(Section,x86Reg,Opcode.BRANCH.rs,FALSE),&GPR[Opcode.BRANCH.rt].W[0],GPR_NameLo[Opcode.BRANCH.rt]);
		if (Section->Cont.FallThrough) {
			JeLabel32 ( &RecompPos, Section->Jump.BranchLabel, 0 );
			Section->Jump.LinkLocation = RecompPos - 4;
			CPU_Message("      ");
...
void BGTZ_Compare (BLOCK_SECTION * Section) {
	if (IsConst(Opcode.BRANCH.rs)) {
		...
		CompConstToX86reg(&RecompPos, MipsRegLo(Opcode.BRANCH.rs),0);
		if (Section->Jump.FallThrough) {
			JleLabel32 (&RecompPos, Section->Cont.BranchLabel, 0 );
			Section->Cont.LinkLocation = RecompPos - 4;
		} else if (Section->Cont.FallThrough) {
			JgLabel32(&RecompPos, Section->Jump.BranchLabel,0);
			Section->Jump.LinkLocation = RecompPos - 4;
		} else {
			JleLabel32 (&RecompPos, Section->Cont.BranchLabel, 0 );
			Section->Cont.LinkLocation = RecompPos - 4;
		...
		if (IsMapped(Opcode.BRANCH.rs)) {
			CompConstToX86reg(&RecompPos, MipsRegHi(Opcode.BRANCH.rs),0);
		} else {
			CompConstToVariable(&RecompPos, 0,&GPR[Opcode.BRANCH.rs].W[1],GPR_NameHi[Opcode.BRANCH.rs]);
		}
		if (Section->Jump.FallThrough) {
			JlLabel32 (&RecompPos, Section->Cont.BranchLabel, 0 );
			Section->Cont.LinkLocation = RecompPos - 4;
			JgLabel8(&RecompPos, "continue",0);
			Jump = RecompPos - 1;
		} else if (Section->Cont.FallThrough) {
			JlLabel8(&RecompPos, "continue",0);
			Jump = RecompPos - 1;
			JgLabel32(&RecompPos, Section->Jump.BranchLabel,0);
			Section->Jump.LinkLocation = RecompPos - 4;
		} else {
		...
		if (IsMapped(Opcode.BRANCH.rs)) {
			...
			CompConstToVariable(&RecompPos, 0,&GPR[Opcode.BRANCH.rs].W[0],GPR_NameLo[Opcode.BRANCH.rs]);
		}
		if (Section->Jump.FallThrough) {
			JeLabel32 (&RecompPos, Section->Cont.BranchLabel, 0 );
			Section->Cont.LinkLocation2 = RecompPos - 4;
			...
			*((BYTE *)(Jump))=(BYTE)(RecompPos - Jump - 1);
			...
			JneLabel32(&RecompPos, Section->Jump.BranchLabel,0);
			Section->Jump.LinkLocation = RecompPos - 4;
			JmpLabel32 (&RecompPos, Section->Cont.BranchLabel, 0 );
			Section->Cont.LinkLocation2 = RecompPos - 4;
		}
	}
}
...
void BLEZ_Compare (BLOCK_SECTION * Section) {
	if (IsConst(Opcode.BRANCH.rs)) {
		...
		if (IsMapped(Opcode.BRANCH.rs) && Is32Bit(Opcode.BRANCH.rs)) {
			CompConstToX86reg(&RecompPos, MipsRegLo(Opcode.BRANCH.rs),0);
			if (Section->Jump.FallThrough) {
				JgLabel32 (&RecompPos, Section->Cont.BranchLabel, 0 );
				Section->Cont.LinkLocation = RecompPos - 4;
			} else if (Section->Cont.FallThrough) {
				JleLabel32(&RecompPos, Section->Jump.BranchLabel,0);
				Section->Jump.LinkLocation = RecompPos - 4;
			} else {
				JgLabel32 (&RecompPos, Section->Cont.BranchLabel, 0 );
				Section->Cont.LinkLocation = RecompPos - 4;
			...
			if (Section->Jump.FallThrough) {
				...
				JgLabel8(&RecompPos, "Continue",0);
				Jump = RecompPos - 1;
				JlLabel32(&RecompPos, Section->Jump.BranchLabel,0);
				Section->Jump.LinkLocation = RecompPos - 4;
			} else {
				JgLabel32 (&RecompPos, Section->Cont.BranchLabel, 0 );
				Section->Cont.LinkLocation = RecompPos - 4;
			...
			if (Section->Jump.FallThrough) {
				...
				CPU_Message("      continue:");
				*((BYTE *)(Jump))=(BYTE)(RecompPos - Jump - 1);
			} else if (Section->Cont.FallThrough) {&RecompPos,
				JeLabel32 (&RecompPos, Section->Jump.BranchLabel, 0 );
				Section->Jump.LinkLocation2 = RecompPos - 4;
				CPU_Message("      continue:");
				*((BYTE *)(Jump))=(BYTE)(RecompPos - Jump - 1);
				...
				JneLabel32 (&RecompPos, Section->Cont.BranchLabel, 0 );
				Section->Cont.LinkLocation2 = RecompPos - 4;
				JmpLabel32(&RecompPos, "BranchToJump",0);
				Section->Jump.LinkLocation2 = RecompPos - 4;
			}
		}
	}
...
void BLTZ_Compare (BLOCK_SECTION * Section) {
	if (IsConst(Opcode.BRANCH.rs)) {
		...
		if (Is64Bit(Opcode.BRANCH.rs)) {
			CompConstToX86reg(&RecompPos, MipsRegHi(Opcode.BRANCH.rs),0);
			if (Section->Jump.FallThrough) {
				JgeLabel32 (&RecompPos, Section->Cont.BranchLabel, 0 );
				Section->Cont.LinkLocation = RecompPos - 4;
			} else if (Section->Cont.FallThrough) {
				JlLabel32(&RecompPos, Section->Jump.BranchLabel,0);
				Section->Jump.LinkLocation = RecompPos - 4;
...
void BGEZ_Compare (BLOCK_SECTION * Section) {
	if (IsConst(Opcode.BRANCH.rs)) {
		...
		if (Is64Bit(Opcode.BRANCH.rs)) { 
			CompConstToX86reg(&RecompPos, MipsRegHi(Opcode.BRANCH.rs),0);
			if (Section->Cont.FallThrough) {
				JgeLabel32 (&RecompPos, Section->Jump.BranchLabel, 0 );
				Section->Jump.LinkLocation = RecompPos - 4;
			} else if (Section->Jump.FallThrough) {
				JlLabel32 (&RecompPos, Section->Cont.BranchLabel, 0 );
				Section->Cont.LinkLocation = RecompPos - 4;
...
void COP1_BCF_Compare (BLOCK_SECTION * Section) {
	TestVariable(&RecompPos, FPCSR_C,&FPCR[31],"FPCR[31]");
	if (Section->Cont.FallThrough) {
		JeLabel32 (&RecompPos, Section->Jump.BranchLabel, 0 );
		Section->Jump.LinkLocation = RecompPos - 4;
	} else if (Section->Jump.FallThrough) {
...
void Compile_R4300i_JAL (BLOCK_SECTION * Section) {
	...
	if ( NextInstruction == NORMAL ) {
		...
		MipsRegState(31) = STATE_CONST_32;
		if ((Section->CompilePC & 0xFFC) == 0xFFC) {
			MoveConstToVariable(&RecompPos, (Section->CompilePC & 0xF0000000) + (Opcode.JMP.target << 2),&JumpToLocation,"JumpToLocation");
		...
		MoveConstToVariable(&RecompPos, (Section->CompilePC & 0xF0000000) + (Opcode.JMP.target << 2),&PROGRAM_COUNTER,"PROGRAM_COUNTER");
...
void Compile_R4300i_ADDI (BLOCK_SECTION * Section) {
	...
	if (SPHack && Opcode.BRANCH.rs == 29 && Opcode.BRANCH.rt == 29) {
		AddConstToX86Reg(&RecompPos, Map_MemoryStack(Section, TRUE),(short)Opcode.IMM.immediate);
	}
	...
	if (Opcode.IMM.immediate == 0) { 
		...
		IncX86reg(&RecompPos, MipsRegLo(Opcode.BRANCH.rt));
	} else if (Opcode.IMM.immediate == 0xFFFF) {			
		DecX86reg(&RecompPos, MipsRegLo(Opcode.BRANCH.rt));
	} else {
		AddConstToX86Reg(&RecompPos, MipsRegLo(Opcode.BRANCH.rt),(short)Opcode.IMM.immediate);
	}
...
void Compile_R4300i_SLTIU (BLOCK_SECTION * Section) {
	...
	if (IsConst(Opcode.BRANCH.rs)) { 
		...
		if (Is64Bit(Opcode.BRANCH.rs)) {
			...
			CompConstToX86reg(&RecompPos, MipsRegHi(Opcode.BRANCH.rs),((short)Opcode.IMM.immediate >> 31));
			JeLabel8(&RecompPos, "Low Compare",0);
			Jump[0] = RecompPos - 1;
			SetbVariable(&RecompPos, &BranchCompare,"BranchCompare");
			JmpLabel8(&RecompPos, "Continue",0);
			Jump[1] = RecompPos - 1;
			CPU_Message("");
			CPU_Message("      Low Compare:");
			*((BYTE *)(Jump[0]))=(BYTE)(RecompPos - Jump[0] - 1);
			CompConstToX86reg(&RecompPos, MipsRegLo(Opcode.BRANCH.rs),(short)Opcode.IMM.immediate);
			SetbVariable(&RecompPos, &BranchCompare,"BranchCompare");
			CPU_Message("");
			CPU_Message("      Continue:");
			*((BYTE *)(Jump[1]))=(BYTE)(RecompPos - Jump[1] - 1);
			Map_GPR_32bit(Section,Opcode.BRANCH.rt,FALSE, -1);
			MoveVariableToX86reg(&RecompPos, &BranchCompare,"BranchCompare",MipsRegLo(Opcode.BRANCH.rt));
		} else {
			CompConstToX86reg(&RecompPos, MipsRegLo(Opcode.BRANCH.rs),(short)Opcode.IMM.immediate);
			SetbVariable(&RecompPos, &BranchCompare,"BranchCompare");
			Map_GPR_32bit(Section,Opcode.BRANCH.rt,FALSE, -1);
		...
		CompConstToVariable(&RecompPos, ((short)Opcode.IMM.immediate >> 31),&GPR[Opcode.BRANCH.rs].W[1],GPR_NameHi[Opcode.BRANCH.rs]);
		JneLabel8(&RecompPos, "CompareSet",0);
		Jump = RecompPos - 1;
		CompConstToVariable(&RecompPos, (short)Opcode.IMM.immediate,&GPR[Opcode.BRANCH.rs].W[0],GPR_NameLo[Opcode.BRANCH.rs]);
		CPU_Message("");
...
void Compile_R4300i_SLTI (BLOCK_SECTION * Section) {
	...
	if (IsConst(Opcode.BRANCH.rs)) { 
		...
		if (Is64Bit(Opcode.BRANCH.rs)) {
			...
			JeLabel8(&RecompPos, "Low Compare",0);
			Jump[0] = RecompPos - 1;
			SetlVariable(&RecompPos, &BranchCompare,"BranchCompare");
			JmpLabel8(&RecompPos, "Continue",0);
			Jump[1] = RecompPos - 1;
			CPU_Message("");
			CPU_Message("      Low Compare:");
		...
		/*	CompConstToX86reg(MipsRegLo(Opcode.BRANCH.rs),(short)Opcode.IMM.immediate);
			...
			*/
			...
			if (MipsRegLo(Opcode.BRANCH.rt) > x86_EDX) {
				...
				Setl(&RecompPos, MipsRegLo(Opcode.BRANCH.rt));
				AndConstToX86Reg(&RecompPos, MipsRegLo(Opcode.BRANCH.rt), 1);
			}
		}
	} else {
		BYTE * Jump[2];
...
void Compile_R4300i_ANDI (BLOCK_SECTION * Section) {
	...
	if (IsConst(Opcode.BRANCH.rs)) {
		...
		AndConstToX86Reg(&RecompPos, MipsRegLo(Opcode.BRANCH.rt),Opcode.IMM.immediate);
	} else {
...
void Compile_R4300i_ORI (BLOCK_SECTION * Section) {
	...
	if (IsConst(Opcode.BRANCH.rs)) {
		...
		OrConstToX86Reg(&RecompPos, Opcode.IMM.immediate,MipsRegLo(Opcode.BRANCH.rt));
	} else {
		Map_GPR_64bit(Section,Opcode.BRANCH.rt,Opcode.BRANCH.rs);
		OrConstToX86Reg(&RecompPos, Opcode.IMM.immediate,MipsRegLo(Opcode.BRANCH.rt));
	}
...
void Compile_R4300i_XORI (BLOCK_SECTION * Section) {
	...
	if (IsConst(Opcode.BRANCH.rs)) {
		...
		if (Opcode.IMM.immediate != 0) { XorConstToX86Reg(&RecompPos, MipsRegLo(Opcode.BRANCH.rt),Opcode.IMM.immediate); }
	}
}
...
void Compile_R4300i_LUI (BLOCK_SECTION * Section) {
	...
	if (SPHack && Opcode.BRANCH.rt == 29) {
		...
		if (x86reg < 0) {
			MoveConstToVariable(&RecompPos, (DWORD)(Address + N64MEM), &MemoryStack, "MemoryStack");
		} else {
			MoveConstToX86reg(&RecompPos, (DWORD)(Address + N64MEM), x86reg);
		}
	}
	UnMap_GPR(Section,Opcode.BRANCH.rt, FALSE);
...
void Compile_R4300i_DADDI (BLOCK_SECTION * Section) {
	...
	Pushad(&RecompPos);
	MoveConstToVariable(&RecompPos, Opcode.Hex, &Opcode.Hex, "Opcode.Hex" );
	Call_Direct(&RecompPos, (void*)r4300i_DADDI, "r4300i_DADDI");
	Popad(&RecompPos);
}
...
void Compile_R4300i_DADDIU (BLOCK_SECTION * Section) {
	...
	Pushad(&RecompPos);
	MoveConstToVariable(&RecompPos, Opcode.Hex, &Opcode.Hex, "Opcode.Hex" );
	Call_Direct(&RecompPos, (void*)r4300i_DADDIU, "r4300i_DADDIU");
	Popad(&RecompPos);
}
...
void Compile_R4300i_LDL (BLOCK_SECTION * Section) {
	...
	Pushad(&RecompPos);
	MoveConstToVariable(&RecompPos, Opcode.Hex, &Opcode.Hex, "Opcode.Hex" );
	Call_Direct(&RecompPos, (void*)r4300i_LDL, "r4300i_LDL");
	Popad(&RecompPos);
...
void Compile_R4300i_LDR (BLOCK_SECTION * Section) {
	...
	Pushad(&RecompPos);
	MoveConstToVariable(&RecompPos, Opcode.Hex, &Opcode.Hex, "Opcode.Hex" );
	Call_Direct(&RecompPos, (void*)r4300i_LDR, "r4300i_LDR");
	Popad(&RecompPos);
}
...
void Compile_R4300i_LB (BLOCK_SECTION * Section) {
	...
	if (IsMapped(Opcode.IMM.base)) { 
		...
		if (Opcode.IMM.immediate != 0) {
			...
			LeaSourceAndOffset(&RecompPos, TempReg1,MipsRegLo(Opcode.IMM.base),(short)Opcode.IMM.immediate);
		} else {
		...
		if (Opcode.IMM.immediate == 0) { 
			...
			IncX86reg(&RecompPos, TempReg1);
		} else if (Opcode.IMM.immediate == 0xFFFF) {			
			DecX86reg(&RecompPos, TempReg1);
		} else {
			AddConstToX86Reg(&RecompPos, TempReg1,(short)Opcode.IMM.immediate);
		}
	}
	if (UseTlb) {
		TempReg2 = Map_TempReg(Section,x86_Any,-1,FALSE);
		MoveX86RegToX86Reg(&RecompPos, TempReg1, TempReg2);
		ShiftRightUnsignImmed(&RecompPos, TempReg2,12);
		MoveVariableDispToX86Reg(&RecompPos, TLB_ReadMap,"TLB_ReadMap",TempReg2,TempReg2,4);
		CompileReadTLBMiss(Section,TempReg1,TempReg2);
		XorConstToX86Reg(&RecompPos, TempReg1,3);
		Map_GPR_32bit(Section,Opcode.BRANCH.rt,TRUE,-1);
		MoveSxByteX86regPointerToX86reg(&RecompPos, TempReg1, TempReg2,MipsRegLo(Opcode.BRANCH.rt));
	} else {
		AndConstToX86Reg(&RecompPos, TempReg1,0x1FFFFFFF);
		XorConstToX86Reg(&RecompPos, TempReg1,3);
		Map_GPR_32bit(Section,Opcode.BRANCH.rt,TRUE,-1);
		MoveSxN64MemToX86regByte(&RecompPos, MipsRegLo(Opcode.BRANCH.rt), TempReg1);
	}
}
...
void Compile_R4300i_LH (BLOCK_SECTION * Section) {
	...
	if (UseTlb) {
		...
		MoveVariableDispToX86Reg(&RecompPos, TLB_ReadMap,"TLB_ReadMap",TempReg2,TempReg2,4);
		CompileReadTLBMiss(Section,TempReg1,TempReg2);
		XorConstToX86Reg(&RecompPos, TempReg1,2);
		Map_GPR_32bit(Section,Opcode.BRANCH.rt,TRUE,-1);
		MoveSxHalfX86regPointerToX86reg(&RecompPos, TempReg1, TempReg2,MipsRegLo(Opcode.BRANCH.rt));
	} else {
		AndConstToX86Reg(&RecompPos, TempReg1,0x1FFFFFFF);
		XorConstToX86Reg(&RecompPos, TempReg1,2);
		Map_GPR_32bit(Section,Opcode.BRANCH.rt,TRUE,-1);
		MoveSxN64MemToX86regHalf(&RecompPos, MipsRegLo(Opcode.BRANCH.rt), TempReg1);
	}
}
...
void Compile_R4300i_LWL (BLOCK_SECTION * Section) {
	...
	if (IsConst(Opcode.IMM.base)) {
		...
		if (Compile_LW(Value, (Address & ~3))) {
			AndConstToX86Reg(&RecompPos, MipsRegLo(Opcode.BRANCH.rt), LWL_MASK[Offset]);
			ShiftLeftSignImmed(&RecompPos, Value, (BYTE)LWL_SHIFT[Offset]);
			AddX86RegToX86Reg(&RecompPos, MipsRegLo(Opcode.BRANCH.rt), Value);
			return;
		}
	...
	MoveX86RegToX86Reg(&RecompPos, TempReg1, Offset);
	AndConstToX86Reg(&RecompPos, Offset,3);
	AndConstToX86Reg(&RecompPos, TempReg1,(DWORD)~3);

	Map_GPR_32bit(Section,Opcode.BRANCH.rt,TRUE,Opcode.BRANCH.rt);
	AndVariableDispToX86Reg(&RecompPos, LWL_MASK,"LWL_MASK",MipsRegLo(Opcode.BRANCH.rt),Offset,4);
	MoveVariableDispToX86Reg(&RecompPos, LWL_SHIFT,"LWL_SHIFT",shift,Offset,4);
	if (UseTlb) {			
		MoveX86regPointerToX86reg(&RecompPos, TempReg1, TempReg2,TempReg1);
	} else {
		AndConstToX86Reg(&RecompPos, TempReg1,0x1FFFFFFF);
		MoveN64MemToX86reg(&RecompPos, TempReg1,TempReg1);
	}
	ShiftLeftSign(&RecompPos, TempReg1);
	AddX86RegToX86Reg(&RecompPos, MipsRegLo(Opcode.BRANCH.rt),TempReg1);
}
...
void Compile_R4300i_LW (BLOCK_SECTION * Section) {
	...
	if (Opcode.IMM.base == 29 && SPHack) {
		...
		MoveVariableDispToX86Reg(&RecompPos, (void *)((DWORD)(short)Opcode.BRANCH.offset),String,MipsRegLo(Opcode.BRANCH.rt),TempReg1,1);
	} else {
		if (IsConst(Opcode.IMM.base)) { 
		...
		if (UseTlb) {	
			...
			if (IsMapped(Opcode.IMM.base) && Opcode.BRANCH.offset == 0) { 
				...
				if (IsMapped(Opcode.IMM.base)) { 
					...
					if (Opcode.BRANCH.offset != 0) {
						TempReg1 = Map_TempReg(Section,x86_Any,-1,FALSE);
						LeaSourceAndOffset(&RecompPos, TempReg1,MipsRegLo(Opcode.IMM.base),(short)Opcode.BRANCH.offset);
					} else {
						TempReg1 = Map_TempReg(Section,x86_Any,Opcode.IMM.base,FALSE);
					}
				} else {
			...
			CompileReadTLBMiss(Section,TempReg1,TempReg2);
			Map_GPR_32bit(Section,Opcode.BRANCH.rt,TRUE,-1);
			MoveX86regPointerToX86reg(&RecompPos, TempReg1, TempReg2,MipsRegLo(Opcode.BRANCH.rt));
		} else {
			if (IsMapped(Opcode.IMM.base)) { 
				ProtectGPR(Section,Opcode.IMM.base);
				if (Opcode.BRANCH.offset != 0) {
					Map_GPR_32bit(Section,Opcode.BRANCH.rt,TRUE,-1);
					LeaSourceAndOffset(&RecompPos, MipsRegLo(Opcode.BRANCH.rt),MipsRegLo(Opcode.IMM.base),(short)Opcode.BRANCH.offset);
				} else {
			...
			AndConstToX86Reg(&RecompPos, MipsRegLo(Opcode.BRANCH.rt),0x1FFFFFFF);
			MoveN64MemToX86reg(&RecompPos, MipsRegLo(Opcode.BRANCH.rt),MipsRegLo(Opcode.BRANCH.rt));
		}
	}
}
...
void Compile_R4300i_LBU (BLOCK_SECTION * Section) {
	...
	if (UseTlb) {
		...
		XorConstToX86Reg(&RecompPos, TempReg1,3);
		Map_GPR_32bit(Section,Opcode.BRANCH.rt,FALSE,-1);
		MoveZxByteX86regPointerToX86reg(&RecompPos, TempReg1, TempReg2,MipsRegLo(Opcode.BRANCH.rt));
	} else {
		AndConstToX86Reg(&RecompPos, TempReg1,0x1FFFFFFF);
		XorConstToX86Reg(&RecompPos, TempReg1,3);
		Map_GPR_32bit(Section,Opcode.BRANCH.rt,FALSE,-1);
		MoveZxN64MemToX86regByte(&RecompPos, MipsRegLo(Opcode.BRANCH.rt), TempReg1);
	}
}
...
void Compile_R4300i_LHU (BLOCK_SECTION * Section) {
	...
	if (UseTlb) {
		...
		XorConstToX86Reg(&RecompPos, TempReg1,2);
		Map_GPR_32bit(Section,Opcode.BRANCH.rt,FALSE,-1);
		MoveZxHalfX86regPointerToX86reg(&RecompPos, TempReg1, TempReg2,MipsRegLo(Opcode.BRANCH.rt));
	} else {
		AndConstToX86Reg(&RecompPos, TempReg1,0x1FFFFFFF);
		XorConstToX86Reg(&RecompPos, TempReg1,2);
		Map_GPR_32bit(Section,Opcode.BRANCH.rt,TRUE,-1);
		MoveZxN64MemToX86regHalf(&RecompPos, MipsRegLo(Opcode.BRANCH.rt), TempReg1);
	}
}
...
void Compile_R4300i_LWR (BLOCK_SECTION * Section) {
	...
	if (IsConst(Opcode.IMM.base)) { 
		...
		Value = Map_TempReg(Section,x86_Any,-1,FALSE);
		if (Compile_LW(Value, (Address & ~3))) {
			AndConstToX86Reg(&RecompPos, MipsRegLo(Opcode.BRANCH.rt), LWR_MASK[Offset]);
			ShiftRightUnsignImmed(&RecompPos, Value, (BYTE)LWR_SHIFT[Offset]);
			AddX86RegToX86Reg(&RecompPos, MipsRegLo(Opcode.BRANCH.rt), Value);
			return;
		}
	...
	Map_GPR_32bit(Section,Opcode.BRANCH.rt,TRUE,Opcode.BRANCH.rt);
	AndVariableDispToX86Reg(&RecompPos, LWR_MASK,"LWR_MASK",MipsRegLo(Opcode.BRANCH.rt),Offset,4);
	MoveVariableDispToX86Reg(&RecompPos, LWR_SHIFT,"LWR_SHIFT",shift,Offset,4);
	if (UseTlb) {
		MoveX86regPointerToX86reg(&RecompPos, TempReg1, TempReg2,TempReg1);
	} else {
		AndConstToX86Reg(&RecompPos, TempReg1,0x1FFFFFFF);
	...
	ShiftRightUnsign(&RecompPos, TempReg1);
	AddX86RegToX86Reg(&RecompPos, MipsRegLo(Opcode.BRANCH.rt),TempReg1);
}
...
void Compile_R4300i_SB (BLOCK_SECTION * Section){
	...
	if (UseTlb) {
		...
		MoveX86RegToX86Reg(&RecompPos, TempReg1, TempReg2);
		ShiftRightUnsignImmed(&RecompPos, TempReg2,12);
		MoveVariableDispToX86Reg(&RecompPos, TLB_WriteMap,"TLB_WriteMap",TempReg2,TempReg2,4);
		...
		XorConstToX86Reg(&RecompPos, TempReg1,3);
		if (IsConst(Opcode.BRANCH.rt)) {
			MoveConstByteToX86regPointer(&RecompPos, (BYTE)MipsRegLo(Opcode.BRANCH.rt),TempReg1, TempReg2);
		} else if (IsMapped(Opcode.BRANCH.rt) && Is8BitReg(MipsRegLo(Opcode.BRANCH.rt))) {
			MoveX86regByteToX86regPointer(&RecompPos, MipsRegLo(Opcode.BRANCH.rt),TempReg1, TempReg2);
		} else {	
			UnProtectGPR(Section,Opcode.BRANCH.rt);
			MoveX86regByteToX86regPointer(&RecompPos, Map_TempReg(Section,x86_Any8Bit,Opcode.BRANCH.rt,FALSE),TempReg1, TempReg2);
		}
	} else {
		AndConstToX86Reg(&RecompPos, TempReg1,0x1FFFFFFF);
		XorConstToX86Reg(&RecompPos, TempReg1,3);
		if (IsConst(Opcode.BRANCH.rt)) {
			MoveConstByteToN64Mem(&RecompPos, (BYTE)MipsRegLo(Opcode.BRANCH.rt),TempReg1);
		} else if (IsMapped(Opcode.BRANCH.rt) && Is8BitReg(MipsRegLo(Opcode.BRANCH.rt))) {
			MoveX86regByteToN64Mem(&RecompPos, MipsRegLo(Opcode.BRANCH.rt),TempReg1);
		} else {	
			UnProtectGPR(Section,Opcode.BRANCH.rt);
			MoveX86regByteToN64Mem(&RecompPos, Map_TempReg(Section,x86_Any8Bit,Opcode.BRANCH.rt,FALSE),TempReg1);
		}
	}
...
void Compile_R4300i_SH (BLOCK_SECTION * Section){
	...
	if (UseTlb) {
		...
		XorConstToX86Reg(&RecompPos, TempReg1,2);
		if (IsConst(Opcode.BRANCH.rt)) {
			MoveConstHalfToX86regPointer(&RecompPos, (WORD)MipsRegLo(Opcode.BRANCH.rt),TempReg1, TempReg2);
		} else if (IsMapped(Opcode.BRANCH.rt)) {
			MoveX86regHalfToX86regPointer(&RecompPos, MipsRegLo(Opcode.BRANCH.rt),TempReg1, TempReg2);
		} else {	
			MoveX86regHalfToX86regPointer(&RecompPos, Map_TempReg(Section,x86_Any,Opcode.BRANCH.rt,FALSE),TempReg1, TempReg2);
		}
	} else {
		AndConstToX86Reg(&RecompPos, TempReg1,0x1FFFFFFF);
		XorConstToX86Reg(&RecompPos, TempReg1,2);
		if (IsConst(Opcode.BRANCH.rt)) {
			MoveConstHalfToN64Mem(&RecompPos, (WORD)MipsRegLo(Opcode.BRANCH.rt),TempReg1);
		} else if (IsMapped(Opcode.BRANCH.rt)) {
			MoveX86regHalfToN64Mem(&RecompPos, MipsRegLo(Opcode.BRANCH.rt),TempReg1);
		} else {	
			MoveX86regHalfToN64Mem(&RecompPos, Map_TempReg(Section,x86_Any,Opcode.BRANCH.rt,FALSE),TempReg1);
		}
	}
}
...
void Compile_R4300i_SWL (BLOCK_SECTION * Section) {
	...
	if (IsConst(Opcode.IMM.base)) { 
		...
		Value = Map_TempReg(Section,x86_Any,-1,FALSE);
		if (Compile_LW(Value, (Address & ~3))) {
			AndConstToX86Reg(&RecompPos, Value, SWL_MASK[Offset]);
			TempReg1 = Map_TempReg(Section, x86_Any, Opcode.BRANCH.rt, FALSE);
			ShiftRightUnsignImmed(&RecompPos, TempReg1, (BYTE)SWL_SHIFT[Offset]);
			AddX86RegToX86Reg(&RecompPos, Value, TempReg1);
	...
	Value = Map_TempReg(Section,x86_Any,-1,FALSE);
	if (UseTlb) {	
		MoveX86regPointerToX86reg(&RecompPos, TempReg1, TempReg2,Value);
	} else {
		AndConstToX86Reg(&RecompPos, TempReg1,0x1FFFFFFF);
		MoveN64MemToX86reg(&RecompPos, Value,TempReg1);
	}

	AndVariableDispToX86Reg(&RecompPos, SWL_MASK,"SWL_MASK",Value,Offset,4);
	if (!IsConst(Opcode.BRANCH.rt) || MipsRegLo(Opcode.BRANCH.rt) != 0) {
		MoveVariableDispToX86Reg(&RecompPos, SWL_SHIFT,"SWL_SHIFT",shift,Offset,4);
		if (IsConst(Opcode.BRANCH.rt)) {
			MoveConstToX86reg(&RecompPos, MipsRegLo(Opcode.BRANCH.rt),Offset);
		} else if (IsMapped(Opcode.BRANCH.rt)) {
			MoveX86RegToX86Reg(&RecompPos, MipsRegLo(Opcode.BRANCH.rt),Offset);
		} else {
			MoveVariableToX86reg(&RecompPos, &GPR[Opcode.BRANCH.rt].UW[0],GPR_NameLo[Opcode.BRANCH.rt],Offset);
		}
		ShiftRightUnsign(&RecompPos, Offset);
		AddX86RegToX86Reg(&RecompPos, Value,Offset);
	}
	...
	if (UseTlb) {
		...
		MoveX86regToX86regPointer(&RecompPos, Value,TempReg1, TempReg2);
	} else {
		MoveX86regToN64Mem(&RecompPos, Value,TempReg1);
	}
}
...
void Compile_R4300i_SW (BLOCK_SECTION * Section){
	...
	if (Opcode.IMM.base == 29 && SPHack) {
		...
		if (IsConst(Opcode.BRANCH.rt)) {
			MoveConstToMemoryDisp (&RecompPos, MipsRegLo(Opcode.BRANCH.rt),TempReg1, (DWORD)((short)Opcode.BRANCH.offset));
		} else if (IsMapped(Opcode.BRANCH.rt)) {
			MoveX86regToMemory(&RecompPos, MipsRegLo(Opcode.BRANCH.rt),TempReg1,(DWORD)((short)Opcode.BRANCH.offset));
		} else {	
			TempReg2 = Map_TempReg(Section,x86_Any,Opcode.BRANCH.rt,FALSE);
			MoveX86regToMemory(&RecompPos, TempReg2,TempReg1,(DWORD)((short)Opcode.BRANCH.offset));
		}		
	} else {
		if (IsConst(Opcode.IMM.base)) { 
			DWORD Address = MipsRegLo(Opcode.IMM.base) + (short)Opcode.BRANCH.offset;
		...
		if (UseTlb) {
			...
			if (IsConst(Opcode.BRANCH.rt)) {
				MoveConstToX86regPointer(&RecompPos, MipsRegLo(Opcode.BRANCH.rt),TempReg1, TempReg2);
			} else if (IsMapped(Opcode.BRANCH.rt)) {
				MoveX86regToX86regPointer(&RecompPos, MipsRegLo(Opcode.BRANCH.rt),TempReg1, TempReg2);
			} else {	
				MoveX86regToX86regPointer(&RecompPos, Map_TempReg(Section,x86_Any,Opcode.BRANCH.rt,FALSE),TempReg1, TempReg2);
			}
		} else {
			AndConstToX86Reg(&RecompPos, TempReg1,0x1FFFFFFF);
			if (IsConst(Opcode.BRANCH.rt)) {
				MoveConstToN64Mem(&RecompPos, MipsRegLo(Opcode.BRANCH.rt),TempReg1);
			} else if (IsMapped(Opcode.BRANCH.rt)) {
				MoveX86regToN64Mem(&RecompPos, MipsRegLo(Opcode.BRANCH.rt),TempReg1);
			} else {	
				MoveX86regToN64Mem(&RecompPos, Map_TempReg(Section,x86_Any,Opcode.BRANCH.rt,FALSE),TempReg1);
			}
		}
	}
}
...
void Compile_R4300i_SWR (BLOCK_SECTION * Section) {
	...
	if (IsConst(Opcode.IMM.base)) { 
		...
		Value = Map_TempReg(Section,x86_Any,-1,FALSE);
		if (Compile_LW(Value, (Address & ~3))) {
			AndConstToX86Reg(&RecompPos, Value, SWR_MASK[Offset]);
			TempReg1 = Map_TempReg(Section, x86_Any, Opcode.BRANCH.rt, FALSE);
			ShiftLeftSignImmed(&RecompPos, TempReg1, (BYTE)SWR_SHIFT[Offset]);
			AddX86RegToX86Reg(&RecompPos, Value, TempReg1);
			Compile_SW_Register(Value, (Address & ~3));
			return;
		}
	...
	AndVariableDispToX86Reg(&RecompPos, SWR_MASK,"SWR_MASK",Value,Offset,4);
	if (!IsConst(Opcode.BRANCH.rt) || MipsRegLo(Opcode.BRANCH.rt) != 0) {
		MoveVariableDispToX86Reg(&RecompPos, SWR_SHIFT,"SWR_SHIFT",shift,Offset,4);
		if (IsConst(Opcode.BRANCH.rt)) {
			MoveConstToX86reg(&RecompPos, MipsRegLo(Opcode.BRANCH.rt),Offset);
		} else if (IsMapped(Opcode.BRANCH.rt)) {
			MoveX86RegToX86Reg(&RecompPos, MipsRegLo(Opcode.BRANCH.rt),Offset);
		...
		ShiftLeftSign(&RecompPos, Offset);
		AddX86RegToX86Reg(&RecompPos, Value,Offset);
	}
...
void Compile_R4300i_SDL (BLOCK_SECTION * Section) {
	...
	Pushad(&RecompPos);
	MoveConstToVariable(&RecompPos, Opcode.Hex, &Opcode.Hex, "Opcode.Hex" );
	Call_Direct(&RecompPos, (void*)r4300i_SDL, "r4300i_SDL");
	Popad(&RecompPos);
...
void Compile_R4300i_SDR (BLOCK_SECTION * Section) {
	...
	Pushad(&RecompPos);
	MoveConstToVariable(&RecompPos, Opcode.Hex, &Opcode.Hex, "Opcode.Hex" );
	Call_Direct(&RecompPos, (void*)r4300i_SDR, "r4300i_SDR");
	Popad(&RecompPos);
...
void Compile_R4300i_CACHE (BLOCK_SECTION * Section){
	...
	case 16:
		...
		if (IsConst(Opcode.IMM.base)) { 
			DWORD Address = MipsRegLo(Opcode.IMM.base) + (short)Opcode.BRANCH.offset;
			MoveConstToX86reg(&RecompPos, Address,x86_ECX);
		} else if (IsMapped(Opcode.IMM.base)) { 
			if (MipsRegLo(Opcode.IMM.base) == x86_ECX) {
				AddConstToX86Reg(&RecompPos, x86_ECX,(short)Opcode.BRANCH.offset);
			} else {
				LeaSourceAndOffset(&RecompPos, x86_ECX,MipsRegLo(Opcode.IMM.base),(short)Opcode.BRANCH.offset);
			}
		} else {
			MoveVariableToX86reg(&RecompPos, &GPR[Opcode.IMM.base].UW[0],GPR_NameLo[Opcode.IMM.base],x86_ECX);
			AddConstToX86Reg(&RecompPos, x86_ECX,(short)Opcode.BRANCH.offset);
		}
		Call_Direct(&RecompPos, (void*)ClearRecomplierCache, "ClearRecomplierCache");
		Popad(&RecompPos);
		break;
	case 1:
	case 3:
...
void Compile_R4300i_LL (BLOCK_SECTION * Section) {
	...
	if (IsConst(Opcode.IMM.base)) { 
		...
		Map_GPR_32bit(Section,Opcode.BRANCH.rt,TRUE,-1);
		if (Compile_LW(MipsRegLo(Opcode.BRANCH.rt), Address)) {
			MoveConstToVariable(&RecompPos, 1, &LLBit, "LLBit");
			TranslateVaddr(&Address);
			MoveConstToVariable(&RecompPos, Address, &LLADDR_REGISTER, "LLAddr");
			return;
		}
	...
	if (UseTlb) {	
		...
		MoveX86regPointerToX86reg(&RecompPos, TempReg1, TempReg2,MipsRegLo(Opcode.BRANCH.rt));
		MoveConstToVariable(&RecompPos, 1,&LLBit,"LLBit");
		MoveX86regToVariable(&RecompPos, TempReg1,&LLADDR_REGISTER,"LLAddr");
		AddX86regToVariable(&RecompPos, TempReg2,&LLADDR_REGISTER,"LLAddr");
		SubConstFromVariable(&RecompPos, (DWORD)N64MEM,&LLADDR_REGISTER,"LLAddr");
	} else {
		if (IsMapped(Opcode.IMM.base)) { 
			ProtectGPR(Section,Opcode.IMM.base);
			if (Opcode.BRANCH.offset != 0) {
		...
		AndConstToX86Reg(&RecompPos, MipsRegLo(Opcode.BRANCH.rt),0x1FFFFFFF);
		MoveX86regToVariable(&RecompPos, MipsRegLo(Opcode.BRANCH.rt),&LLADDR_REGISTER,"LLAddr");
		MoveN64MemToX86reg(&RecompPos, MipsRegLo(Opcode.BRANCH.rt),MipsRegLo(Opcode.BRANCH.rt));
		MoveConstToVariable(&RecompPos, 1,&LLBit,"LLBit");
	}
}
...
void Compile_R4300i_SC (BLOCK_SECTION * Section){
	...
	CompConstToVariable(&RecompPos, 1,&LLBit,"LLBit");
	JneLabel32(&RecompPos, "LLBitNotSet",0);
	Jump = RecompPos - 4;
	if (IsConst(Opcode.IMM.base)) { 
		DWORD Address = MipsRegLo(Opcode.IMM.base) + (short)Opcode.BRANCH.offset;
		...
		*((DWORD *)(Jump))=(BYTE)(RecompPos - Jump - 4);
		Map_GPR_32bit(Section,Opcode.BRANCH.rt,FALSE,-1);
		MoveVariableToX86reg(&RecompPos, &LLBit,"LLBit",MipsRegLo(Opcode.BRANCH.rt));
		return;
	}
	if (IsMapped(Opcode.BRANCH.rt)) { ProtectGPR(Section,Opcode.BRANCH.rt); }
	if (IsMapped(Opcode.IMM.base)) { 
...
void Compile_R4300i_LD (BLOCK_SECTION * Section) {
	...
	if (UseTlb) {
		...
		//0041C524 75 01                jne         0041C527
		Map_GPR_64bit(Section,Opcode.BRANCH.rt,-1);
		MoveX86regPointerToX86reg(&RecompPos, TempReg1, TempReg2,MipsRegHi(Opcode.BRANCH.rt));
		MoveX86regPointerToX86regDisp8(&RecompPos, TempReg1, TempReg2,MipsRegLo(Opcode.BRANCH.rt),4);
	} else {
		AndConstToX86Reg(&RecompPos, TempReg1,0x1FFFFFFF);
		Map_GPR_64bit(Section,Opcode.BRANCH.rt,-1);
		MoveN64MemToX86reg(&RecompPos, MipsRegHi(Opcode.BRANCH.rt),TempReg1);
		MoveN64MemDispToX86reg(&RecompPos, MipsRegLo(Opcode.BRANCH.rt),TempReg1,4);
	}
	if (SPHack && Opcode.BRANCH.rt == 29) { 
		int count;
...
void Compile_R4300i_SD (BLOCK_SECTION * Section){
	...
	if (UseTlb) {
		...
		if (IsConst(Opcode.BRANCH.rt)) {
			if (Is64Bit(Opcode.BRANCH.rt)) {
				MoveConstToX86regPointer(&RecompPos, MipsRegHi(Opcode.BRANCH.rt),TempReg1, TempReg2);
			} else {
				MoveConstToX86regPointer(&RecompPos, (MipsRegLo_S(Opcode.BRANCH.rt) >> 31),TempReg1, TempReg2);
			}
			AddConstToX86Reg(&RecompPos, TempReg1,4);
			MoveConstToX86regPointer(&RecompPos, MipsRegLo(Opcode.BRANCH.rt),TempReg1, TempReg2);
		} else if (IsMapped(Opcode.BRANCH.rt)) {
			if (Is64Bit(Opcode.BRANCH.rt)) {
				MoveX86regToX86regPointer(&RecompPos, MipsRegHi(Opcode.BRANCH.rt),TempReg1, TempReg2);
			} else {
				MoveX86regToX86regPointer(&RecompPos, Map_TempReg(Section,x86_Any,Opcode.BRANCH.rt,TRUE),TempReg1, TempReg2);
			}
			AddConstToX86Reg(&RecompPos, TempReg1,4);
			MoveX86regToX86regPointer(&RecompPos, MipsRegLo(Opcode.BRANCH.rt),TempReg1, TempReg2);
		} else {	
			int X86Reg = Map_TempReg(Section,x86_Any,Opcode.BRANCH.rt,TRUE);
			MoveX86regToX86regPointer(&RecompPos, X86Reg,TempReg1, TempReg2);
			AddConstToX86Reg(&RecompPos, TempReg1,4);
			MoveX86regToX86regPointer(&RecompPos, Map_TempReg(Section,X86Reg,Opcode.BRANCH.rt,FALSE),TempReg1, TempReg2);
		}
	} else {
		AndConstToX86Reg(&RecompPos, TempReg1,0x1FFFFFFF);
		if (IsConst(Opcode.BRANCH.rt)) {
			if (Is64Bit(Opcode.BRANCH.rt)) {
				MoveConstToN64Mem(&RecompPos, MipsRegHi(Opcode.BRANCH.rt),TempReg1);
			} else if (IsSigned(Opcode.BRANCH.rt)) {
				MoveConstToN64Mem(&RecompPos, ((int)MipsRegLo(Opcode.BRANCH.rt) >> 31),TempReg1);
			} else {
				MoveConstToN64Mem(&RecompPos, 0,TempReg1);
			}
			MoveConstToN64MemDisp(&RecompPos, MipsRegLo(Opcode.BRANCH.rt),TempReg1,4);
		} else if (IsKnown(Opcode.BRANCH.rt) && IsMapped(Opcode.BRANCH.rt)) {
			if (Is64Bit(Opcode.BRANCH.rt)) {
				MoveX86regToN64Mem(&RecompPos, MipsRegHi(Opcode.BRANCH.rt),TempReg1);
			} else if (IsSigned(Opcode.BRANCH.rt)) {
				MoveX86regToN64Mem(&RecompPos, Map_TempReg(Section,x86_Any,Opcode.BRANCH.rt,TRUE), TempReg1);
			} else {
				MoveConstToN64Mem(&RecompPos, 0,TempReg1);
			}
			MoveX86regToN64MemDisp(&RecompPos, MipsRegLo(Opcode.BRANCH.rt),TempReg1, 4);
		} else {	
			int x86reg;
			MoveX86regToN64Mem(&RecompPos, x86reg = Map_TempReg(Section,x86_Any,Opcode.BRANCH.rt,TRUE), TempReg1);
			MoveX86regToN64MemDisp(&RecompPos, Map_TempReg(Section,x86reg,Opcode.BRANCH.rt,FALSE), TempReg1,4);
		}
	}
}
...
void Compile_R4300i_SPECIAL_SLL (BLOCK_SECTION * Section) {
	...
	if (Opcode.REG.rd != Opcode.BRANCH.rt && IsMapped(Opcode.BRANCH.rt)) {
		...
		case 1:
			...
			LeaRegReg(&RecompPos, MipsRegLo(Opcode.REG.rd),MipsRegLo(Opcode.BRANCH.rt), 2);
			break;			
		case 2:
			ProtectGPR(Section,Opcode.BRANCH.rt);
			Map_GPR_32bit(Section,Opcode.REG.rd,TRUE,-1);
			LeaRegReg(&RecompPos, MipsRegLo(Opcode.REG.rd),MipsRegLo(Opcode.BRANCH.rt), 4);
			break;			
		case 3:
			ProtectGPR(Section,Opcode.BRANCH.rt);
			Map_GPR_32bit(Section,Opcode.REG.rd,TRUE,-1);
			LeaRegReg(&RecompPos, MipsRegLo(Opcode.REG.rd),MipsRegLo(Opcode.BRANCH.rt), 8);
			break;
		default:
			Map_GPR_32bit(Section,Opcode.REG.rd,TRUE,Opcode.BRANCH.rt);
			ShiftLeftSignImmed(&RecompPos, MipsRegLo(Opcode.REG.rd),(BYTE)Opcode.REG.sa);
		}
	} else {
		Map_GPR_32bit(Section,Opcode.REG.rd,TRUE,Opcode.BRANCH.rt);
		ShiftLeftSignImmed(&RecompPos, MipsRegLo(Opcode.REG.rd),(BYTE)Opcode.REG.sa);
...
void Compile_R4300i_SPECIAL_SRL (BLOCK_SECTION * Section) {
	...
	Map_GPR_32bit(Section,Opcode.REG.rd,TRUE,Opcode.BRANCH.rt);
	ShiftRightUnsignImmed(&RecompPos, MipsRegLo(Opcode.REG.rd),(BYTE)Opcode.REG.sa);
}
...
void Compile_R4300i_SPECIAL_SRA (BLOCK_SECTION * Section) {
	...
	if (Is32Bit(Opcode.BRANCH.rt)) {
		Map_GPR_32bit(Section, Opcode.REG.rd, TRUE, Opcode.BRANCH.rt);
		ShiftRightSignImmed(&RecompPos, MipsRegLo(Opcode.REG.rd), (BYTE)Opcode.REG.sa);
	} else {
		Map_GPR_64bit(Section, Opcode.REG.rd, Opcode.BRANCH.rt);
		ShiftRightDoubleImmed(&RecompPos, MipsRegLo(Opcode.REG.rd), MipsRegHi(Opcode.REG.rd), (BYTE)Opcode.REG.sa);
		MoveX86RegToX86Reg(&RecompPos, MipsRegLo(Opcode.REG.rd), MipsRegHi(Opcode.REG.rd));
		ShiftRightSignImmed(&RecompPos, MipsRegHi(Opcode.REG.rd), 31);
	}
}
...
void Compile_R4300i_SPECIAL_SLLV (BLOCK_SECTION * Section) {
	...
	if (IsConst(Opcode.BRANCH.rs)) {
		...
		if (IsConst(Opcode.BRANCH.rt)) {
			...
			Map_GPR_32bit(Section,Opcode.REG.rd,TRUE,Opcode.BRANCH.rt);
			ShiftLeftSignImmed(&RecompPos, MipsRegLo(Opcode.REG.rd),(BYTE)Shift);
		}
		return;
	}
	Map_TempReg(Section,x86_ECX,Opcode.BRANCH.rs,FALSE);
	AndConstToX86Reg(&RecompPos, x86_ECX,0x1F);
	Map_GPR_32bit(Section,Opcode.REG.rd,TRUE,Opcode.BRANCH.rt);
	ShiftLeftSign(&RecompPos, MipsRegLo(Opcode.REG.rd));
}
...
void Compile_R4300i_SPECIAL_SRLV (BLOCK_SECTION * Section) {
	...
	if (IsConst(Opcode.BRANCH.rs)) {
		...
		Map_GPR_32bit(Section,Opcode.REG.rd,TRUE,Opcode.BRANCH.rt);
		ShiftRightUnsignImmed(&RecompPos, MipsRegLo(Opcode.REG.rd),(BYTE)Shift);
		return;
	}
	Map_TempReg(Section,x86_ECX,Opcode.BRANCH.rs,FALSE);
	AndConstToX86Reg(&RecompPos, x86_ECX,0x1F);
	Map_GPR_32bit(Section,Opcode.REG.rd,TRUE,Opcode.BRANCH.rt);
	ShiftRightUnsign(&RecompPos, MipsRegLo(Opcode.REG.rd));
}
...
void Compile_R4300i_SPECIAL_SRAV (BLOCK_SECTION * Section) {
	...
	if (IsConst(Opcode.BRANCH.rs)) {
		...
		if (Is32Bit(Opcode.BRANCH.rt)) {
			Map_GPR_32bit(Section, Opcode.REG.rd, TRUE, Opcode.BRANCH.rt);
			ShiftRightSignImmed(&RecompPos, MipsRegLo(Opcode.REG.rd), (BYTE)Shift);
		} else {
			Map_GPR_64bit(Section, Opcode.REG.rd, Opcode.BRANCH.rt);
			ShiftRightDoubleImmed(&RecompPos, MipsRegLo(Opcode.REG.rd), MipsRegHi(Opcode.REG.rd), (BYTE)Shift);
			MoveX86RegToX86Reg(&RecompPos, MipsRegLo(Opcode.REG.rd), MipsRegHi(Opcode.REG.rd));
			ShiftRightSignImmed(&RecompPos, MipsRegHi(Opcode.REG.rd), 31);
		}
		return;
	...
	if (Is32Bit(Opcode.BRANCH.rt)) {
		Map_GPR_32bit(Section, Opcode.REG.rd, TRUE, Opcode.BRANCH.rt);
		ShiftRightSign(&RecompPos, MipsRegLo(Opcode.REG.rd));
	} else {
		Map_GPR_64bit(Section, Opcode.REG.rd, Opcode.BRANCH.rt);
		ShiftRightDouble(&RecompPos, MipsRegLo(Opcode.REG.rd), MipsRegHi(Opcode.REG.rd));
		MoveX86RegToX86Reg(&RecompPos, MipsRegLo(Opcode.REG.rd), MipsRegHi(Opcode.REG.rd));
		ShiftRightSignImmed(&RecompPos, MipsRegHi(Opcode.REG.rd), 31);
	}
}
...
void Compile_R4300i_SPECIAL_JR (BLOCK_SECTION * Section) {
	...
	if ( NextInstruction == NORMAL ) {
		...
		if ((Section->CompilePC & 0xFFC) == 0xFFC) {
			if (IsMapped(Opcode.BRANCH.rs)) { 
				MoveX86regToVariable(&RecompPos, MipsRegLo(Opcode.BRANCH.rs),&JumpToLocation, "JumpToLocation");
			} else {
				MoveX86regToVariable(&RecompPos, Map_TempReg(Section,x86_Any,Opcode.BRANCH.rs,FALSE),&JumpToLocation, "JumpToLocation");
			}
			MoveConstToVariable(&RecompPos, Section->CompilePC + 4,&PROGRAM_COUNTER,"PROGRAM_COUNTER");
			if (BlockCycleCount != 0) { 
				AddConstToVariable(&RecompPos, BlockCycleCount,&CP0[9],Cop0_Name[9]);
		...
		if (DelaySlotEffectsCompare(CompilePC,Opcode.BRANCH.rs,0)) {
			if (IsConst(Opcode.BRANCH.rs)) { 
				MoveConstToVariable(&RecompPos, MipsRegLo(Opcode.BRANCH.rs),&PROGRAM_COUNTER, "PROGRAM_COUNTER");
			} else 	if (IsMapped(Opcode.BRANCH.rs)) { 
				MoveX86regToVariable(&RecompPos, MipsRegLo(Opcode.BRANCH.rs),&PROGRAM_COUNTER, "PROGRAM_COUNTER");
			} else {
				MoveX86regToVariable(&RecompPos, Map_TempReg(Section,x86_Any,Opcode.BRANCH.rs,FALSE),&PROGRAM_COUNTER, "PROGRAM_COUNTER");
			}
		}
		NextInstruction = DO_DELAY_SLOT;
	} else if (NextInstruction == DELAY_SLOT_DONE ) {
...
void Compile_R4300i_SPECIAL_TEQ(BLOCK_SECTION* Section) {
	...
	b1 = (int)RecompPos + 1;
	JneLabel8(&RecompPos, "bypass TEQ", DoTrapLength);
	b2 = (int)RecompPos;
...
void Compile_R4300i_SPECIAL_TGE(BLOCK_SECTION* Section) {
	...
	else if (Opcode.BRANCH.rt == 0)
	{
		...
		CompConstToX86reg(&RecompPos, MipsRegLo(Opcode.BRANCH.rs), 0);
		JlLabel8(&RecompPos, "bypass TGE", DoTrapLength);
		CompileExit(Section->CompilePC, Section->RegWorking, DoTrap, TRUE, NULL);
	}
	else if (Opcode.BRANCH.rs == 0)
	{
...
void Compile_R4300i_SPECIAL_TGEU(BLOCK_SECTION* Section) {
	...
	else if (Opcode.BRANCH.rt == 0)
	{
		Map_GPR_32bit(Section, Opcode.BRANCH.rs, FALSE, Opcode.BRANCH.rs);
		CompConstToX86reg(&RecompPos, MipsRegLo(Opcode.BRANCH.rs), 0);
		JneLabel8(&RecompPos, "bypass TGEU", DoTrapLength);
		CompileExit(Section->CompilePC, Section->RegWorking, DoTrap, TRUE, NULL);
	}
	else if (Opcode.BRANCH.rs == 0)
	{
...
void Compile_R4300i_SPECIAL_TLT(BLOCK_SECTION* Section) {
	...
	else if (Opcode.BRANCH.rt == 0)
	{
		Map_GPR_32bit(Section, Opcode.BRANCH.rs, TRUE, Opcode.BRANCH.rs);
		CompConstToX86reg(&RecompPos, MipsRegLo(Opcode.BRANCH.rs), 0);
		JgeLabel32(&RecompPos, "bypass TLT", DoTrapLength32);
		CompileExit(Section->CompilePC, Section->RegWorking, DoTrap, TRUE, NULL);
	}
	else if (Opcode.BRANCH.rs == 0)
	{
...
void Compile_R4300i_SPECIAL_TLTU(BLOCK_SECTION* Section) {
	...
	else if (Opcode.BRANCH.rt == 0)
	{
		Map_GPR_32bit(Section, Opcode.BRANCH.rs, FALSE, Opcode.BRANCH.rs);
		CompConstToX86reg(&RecompPos, MipsRegLo(Opcode.BRANCH.rs), 0);
		JgeLabel32(&RecompPos, "bypass TLTU", DoTrapLength32);
		CompileExit(Section->CompilePC, Section->RegWorking, DoTrap, TRUE, NULL);
	}
	else if (Opcode.BRANCH.rs == 0)
	{
...
void Compile_R4300i_SPECIAL_MFLO (BLOCK_SECTION * Section) {
	...
	MoveVariableToX86reg(&RecompPos, &LO.UW[0],"LO.UW[0]",MipsRegLo(Opcode.REG.rd));
	MoveVariableToX86reg(&RecompPos, &LO.UW[1],"LO.UW[1]",MipsRegHi(Opcode.REG.rd));
}
...
void Compile_R4300i_SPECIAL_MTLO (BLOCK_SECTION * Section) {
	...
	if (IsKnown(Opcode.BRANCH.rs) && IsConst(Opcode.BRANCH.rs)) {
		if (Is64Bit(Opcode.BRANCH.rs)) {
			MoveConstToVariable(&RecompPos, MipsRegHi(Opcode.BRANCH.rs),&LO.UW[1],"LO.UW[1]");
		} else if (IsSigned(Opcode.BRANCH.rs) && ((MipsRegLo(Opcode.BRANCH.rs) & 0x80000000) != 0)) {
			MoveConstToVariable(&RecompPos, 0xFFFFFFFF,&LO.UW[1],"LO.UW[1]");
		} else {
			MoveConstToVariable(&RecompPos, 0,&LO.UW[1],"LO.UW[1]");
		}
		MoveConstToVariable(&RecompPos, MipsRegLo(Opcode.BRANCH.rs), &LO.UW[0],"LO.UW[0]");
	} else if (IsKnown(Opcode.BRANCH.rs) && IsMapped(Opcode.BRANCH.rs)) {
		if (Is64Bit(Opcode.BRANCH.rs)) {
			MoveX86regToVariable(&RecompPos, MipsRegHi(Opcode.BRANCH.rs),&LO.UW[1],"LO.UW[1]");
		} else if (IsSigned(Opcode.BRANCH.rs)) {
			MoveX86regToVariable(&RecompPos, Map_TempReg(Section,x86_Any,Opcode.BRANCH.rs,TRUE),&LO.UW[1],"LO.UW[1]");
		} else {
			MoveConstToVariable(&RecompPos, 0,&LO.UW[1],"LO.UW[1]");
		}
		MoveX86regToVariable(&RecompPos, MipsRegLo(Opcode.BRANCH.rs), &LO.UW[0],"LO.UW[0]");
	} else {
		int x86reg = Map_TempReg(Section,x86_Any,Opcode.BRANCH.rs,TRUE);
		MoveX86regToVariable(&RecompPos, x86reg,&LO.UW[1],"LO.UW[1]");
		MoveX86regToVariable(&RecompPos, Map_TempReg(Section,x86reg,Opcode.BRANCH.rs,FALSE), &LO.UW[0],"LO.UW[0]");
	}
}
...
void Compile_R4300i_SPECIAL_MFHI (BLOCK_SECTION * Section) {
	...
	Map_GPR_64bit(Section,Opcode.REG.rd,-1);
	MoveVariableToX86reg(&RecompPos, &HI.UW[0],"HI.UW[0]",MipsRegLo(Opcode.REG.rd));
	MoveVariableToX86reg(&RecompPos, &HI.UW[1],"HI.UW[1]",MipsRegHi(Opcode.REG.rd));
}
...
void Compile_R4300i_SPECIAL_MTHI (BLOCK_SECTION * Section) {
	...
	if (IsKnown(Opcode.BRANCH.rs) && IsConst(Opcode.BRANCH.rs)) {
		if (Is64Bit(Opcode.BRANCH.rs)) {
			MoveConstToVariable(&RecompPos, MipsRegHi(Opcode.BRANCH.rs),&HI.UW[1],"HI.UW[1]");
		} else if (IsSigned(Opcode.BRANCH.rs) && ((MipsRegLo(Opcode.BRANCH.rs) & 0x80000000) != 0)) {
			MoveConstToVariable(&RecompPos, 0xFFFFFFFF,&HI.UW[1],"HI.UW[1]");
		} else {
			MoveConstToVariable(&RecompPos, 0,&HI.UW[1],"HI.UW[1]");
		}
		MoveConstToVariable(&RecompPos, MipsRegLo(Opcode.BRANCH.rs), &HI.UW[0],"HI.UW[0]");
	} else if (IsKnown(Opcode.BRANCH.rs) && IsMapped(Opcode.BRANCH.rs)) {
		if (Is64Bit(Opcode.BRANCH.rs)) {
			MoveX86regToVariable(&RecompPos, MipsRegHi(Opcode.BRANCH.rs),&HI.UW[1],"HI.UW[1]");
		} else if (IsSigned(Opcode.BRANCH.rs)) {
			MoveX86regToVariable(&RecompPos, Map_TempReg(Section,x86_Any,Opcode.BRANCH.rs,TRUE),&HI.UW[1],"HI.UW[1]");
		} else {
			MoveConstToVariable(&RecompPos, 0,&HI.UW[1],"HI.UW[1]");
		}
		MoveX86regToVariable(&RecompPos, MipsRegLo(Opcode.BRANCH.rs), &HI.UW[0],"HI.UW[0]");
	} else {
		int x86reg = Map_TempReg(Section,x86_Any,Opcode.BRANCH.rs,TRUE);
		MoveX86regToVariable(&RecompPos, x86reg,&HI.UW[1],"HI.UW[1]");
		MoveX86regToVariable(&RecompPos, Map_TempReg(Section,x86reg,Opcode.BRANCH.rs,FALSE), &HI.UW[0],"HI.UW[0]");
	}
}
...
//		DWORD Shift = (MipsRegLo(Opcode.BRANCH.rs) & 0x3F);
	...
	Map_TempReg(Section,x86_ECX,Opcode.BRANCH.rs,FALSE);
	AndConstToX86Reg(&RecompPos, x86_ECX,0x3F);
	Map_GPR_64bit(Section,Opcode.REG.rd,Opcode.BRANCH.rt);
	CompConstToX86reg(&RecompPos, x86_ECX,0x20);
	JaeLabel8(&RecompPos, "MORE32", 0);
	Jump[0] = RecompPos - 1;
	ShiftLeftDouble(&RecompPos, MipsRegHi(Opcode.REG.rd),MipsRegLo(Opcode.REG.rd));
	ShiftLeftSign(&RecompPos, MipsRegLo(Opcode.REG.rd));
	JmpLabel8(&RecompPos, "continue", 0);
	Jump[1] = RecompPos - 1;
	...
	*((BYTE *)(Jump[0]))=(BYTE)(RecompPos - Jump[0] - 1);
	MoveX86RegToX86Reg(&RecompPos, MipsRegLo(Opcode.REG.rd),MipsRegHi(Opcode.REG.rd));
	XorX86RegToX86Reg(&RecompPos, MipsRegLo(Opcode.REG.rd),MipsRegLo(Opcode.REG.rd));
	AndConstToX86Reg(&RecompPos, x86_ECX,0x1F);
	ShiftLeftSign(&RecompPos, MipsRegHi(Opcode.REG.rd));
...
void Compile_R4300i_SPECIAL_DSRLV (BLOCK_SECTION * Section) {
	...
	Jump[0] = RecompPos - 1;
	ShiftRightDouble(&RecompPos, MipsRegLo(Opcode.REG.rd),MipsRegHi(Opcode.REG.rd));
	ShiftRightUnsign(&RecompPos, MipsRegHi(Opcode.REG.rd));
	JmpLabel8(&RecompPos, "continue", 0);
	Jump[1] = RecompPos - 1;
	...
	CPU_Message("      MORE32:");
	*((BYTE *)(Jump[0]))=(BYTE)(RecompPos - Jump[0] - 1);
	MoveX86RegToX86Reg(&RecompPos, MipsRegHi(Opcode.REG.rd),MipsRegLo(Opcode.REG.rd));
	XorX86RegToX86Reg(&RecompPos, MipsRegHi(Opcode.REG.rd),MipsRegHi(Opcode.REG.rd));
	AndConstToX86Reg(&RecompPos, x86_ECX,0x1F);
	ShiftRightUnsign(&RecompPos, MipsRegLo(Opcode.REG.rd));
...
//		DWORD Shift = (MipsRegLo(Opcode.BRANCH.rs) & 0x3F);
	...
	Jump[0] = RecompPos - 1;
	ShiftRightDouble(&RecompPos, MipsRegLo(Opcode.REG.rd),MipsRegHi(Opcode.REG.rd));
	ShiftRightSign(&RecompPos, MipsRegHi(Opcode.REG.rd));
	JmpLabel8(&RecompPos, "continue", 0);
	Jump[1] = RecompPos - 1;
	...
	*((BYTE *)(Jump[0]))=(BYTE)(RecompPos - Jump[0] - 1);
	MoveX86RegToX86Reg(&RecompPos, MipsRegHi(Opcode.REG.rd),MipsRegLo(Opcode.REG.rd));
	ShiftRightSignImmed(&RecompPos, MipsRegHi(Opcode.REG.rd),0x1F);
	AndConstToX86Reg(&RecompPos, x86_ECX,0x1F);
	ShiftRightSign(&RecompPos, MipsRegLo(Opcode.REG.rd));
...
void Compile_R4300i_SPECIAL_MULT ( BLOCK_SECTION * Section) {
	...
	imulX86reg(&RecompPos, x86_EDX);

	MoveX86regToVariable(&RecompPos, x86_EAX,&LO.UW[0],"LO.UW[0]");
	MoveX86regToVariable(&RecompPos, x86_EDX,&HI.UW[0],"HI.UW[0]");
	ShiftRightSignImmed(&RecompPos, x86_EAX,31);	/* paired */
	ShiftRightSignImmed(&RecompPos, x86_EDX,31);
	MoveX86regToVariable(&RecompPos, x86_EAX,&LO.UW[1],"LO.UW[1]");
	MoveX86regToVariable(&RecompPos, x86_EDX,&HI.UW[1],"HI.UW[1]");
}
...
void Compile_R4300i_SPECIAL_DIV (BLOCK_SECTION * Section) {
	...
	if (IsConst(Opcode.BRANCH.rt)) {
		if (MipsRegLo(Opcode.BRANCH.rs) == INT_MIN && MipsRegLo(Opcode.BRANCH.rt) == -1) {
			...
			MoveConstToVariable(&RecompPos, UINT_MAX / 2 + 1, &LO.UW[0], "LO.UW[0]");
			MoveConstToVariable(&RecompPos, 0, &LO.UW[1], "LO.UW[1]");
			MoveConstToVariable(&RecompPos, 0, &HI.UW[0], "HI.UW[0]");
			MoveConstToVariable(&RecompPos, 0, &HI.UW[1], "HI.UW[1]");
			return;
		}
		if (MipsRegLo(Opcode.BRANCH.rt) == 0) {
			MoveConstToVariable(&RecompPos, 0, &LO.UW[0], "LO.UW[0]");
			MoveConstToVariable(&RecompPos, 0, &LO.UW[1], "LO.UW[1]");
			MoveConstToVariable(&RecompPos, 0, &HI.UW[0], "HI.UW[0]");
			MoveConstToVariable(&RecompPos, 0, &HI.UW[1], "HI.UW[1]");
			return;
		...
		// Check for overflow
		if (IsMapped(Opcode.BRANCH.rs)) {
			CompConstToX86reg(&RecompPos, MipsRegLo(Opcode.BRANCH.rs), (DWORD)INT_MIN);
		} else {
			CompConstToVariable(&RecompPos, (DWORD)INT_MIN, &GPR[Opcode.BRANCH.rs].W[0], GPR_NameLo[Opcode.BRANCH.rs]);
		}
		JneLabel8(&RecompPos, "NoOverflow", 0);
		Jump[0] = RecompPos - 1;

		if (IsMapped(Opcode.BRANCH.rt)) {
			CompConstToX86reg(&RecompPos, MipsRegLo(Opcode.BRANCH.rt), (DWORD)-1);
		} else {
			CompConstToVariable(&RecompPos, (DWORD)-1, &GPR[Opcode.BRANCH.rt].W[0], GPR_NameLo[Opcode.BRANCH.rt]);
		}
		JneLabel8(&RecompPos, "NoOverflow", 0);
		Jump[1] = RecompPos - 1;
		...
		*((BYTE *)(Jump[1])) = (BYTE)(RecompPos - Jump[1] - 1);
		...
		if (IsMapped(Opcode.BRANCH.rt)) {
			CompConstToX86reg(&RecompPos, MipsRegLo(Opcode.BRANCH.rt), 0);
		} else {
			CompConstToVariable(&RecompPos, 0, &GPR[Opcode.BRANCH.rt].W[0], GPR_NameLo[Opcode.BRANCH.rt]);
		}
		// The result for divide-by-zero is undefined, so the LO and HI registers do not need to be updated at all.
		JeLabel8(&RecompPos, "EndDiv", 0);
		Jump[3] = RecompPos - 1;
	}
	/*	lo = (SD)rs / (SD)rt;
		hi = (SD)rs % (SD)rt; */
	...
	MoveX86RegToX86Reg(&RecompPos, x86_EAX, x86_EDX);
	ShiftRightSignImmed(&RecompPos, x86_EDX,31);

	if (IsMapped(Opcode.BRANCH.rt)) {
		idivX86reg(&RecompPos, MipsRegLo(Opcode.BRANCH.rt));
	} else {
		idivX86reg(&RecompPos, Map_TempReg(Section,x86_Any,Opcode.BRANCH.rt,FALSE));
	}
...
void Compile_R4300i_SPECIAL_DIVU ( BLOCK_SECTION * Section) {
	...
	if (IsConst(Opcode.BRANCH.rt)) {
		...
		JneLabel8(&RecompPos, "NoExcept", 0);
		Jump[0] = RecompPos - 1;
...
void Compile_R4300i_SPECIAL_DMULT (BLOCK_SECTION * Section) {
	...
	Pushad(&RecompPos);
	MoveConstToVariable(&RecompPos, Opcode.Hex, &Opcode.Hex, "Opcode.Hex" );
	Call_Direct(&RecompPos, (void*)r4300i_SPECIAL_DMULT, "r4300i_SPECIAL_DMULT");
	Popad(&RecompPos);
}
...
void Compile_R4300i_SPECIAL_DMULTU (BLOCK_SECTION * Section) {
	...
	MulX86reg(&RecompPos, x86_EDX);
	MoveX86regToVariable(&RecompPos, x86_EAX, &LO.UW[0], "LO.UW[0]");
	MoveX86regToVariable(&RecompPos, x86_EDX, &LO.UW[1], "LO.UW[1]");
	...
	MulX86reg(&RecompPos, x86_EDX);
	MoveX86regToVariable(&RecompPos, x86_EAX, &HI.UW[0], "HI.UW[0]");
	MoveX86regToVariable(&RecompPos, x86_EDX, &HI.UW[1], "HI.UW[1]");
	...
	MulX86reg(&RecompPos, x86_EDX);
	MoveX86RegToX86Reg(&RecompPos, x86_EAX, x86_EBX); /* EDX:EAX -> ECX:EBX */
	...
	MoveX86RegToX86Reg(&RecompPos, x86_EAX, x86_ESI); /* EDX:EAX -> EDI:ESI */
	MoveX86RegToX86Reg(&RecompPos, x86_EDX, x86_EDI);

	/* Tmp[2].UDW = (uint64)LO.UW[1] + (uint64)Tmp[0].UW[0] + (uint64)Tmp[1].UW[0]; */
	XorX86RegToX86Reg(&RecompPos, x86_EDX, x86_EDX);
	MoveVariableToX86reg(&RecompPos, &LO.UW[1], "LO.UW[1]", x86_EAX);
	AddX86RegToX86Reg(&RecompPos, x86_EAX, x86_EBX);
	AddConstToX86Reg(&RecompPos, x86_EDX, 0);
	AddX86RegToX86Reg(&RecompPos, x86_EAX, x86_ESI);
	AddConstToX86Reg(&RecompPos, x86_EDX, 0);			/* EDX:EAX */

	/* LO.UDW += ((uint64)Tmp[0].UW[0] + (uint64)Tmp[1].UW[0]) << 32; */
	/* [low+4] += ebx + esi */

	AddX86regToVariable(&RecompPos, x86_EBX, &LO.UW[1], "LO.UW[1]");
	AddX86regToVariable(&RecompPos, x86_ESI, &LO.UW[1], "LO.UW[1]");

	/* HI.UDW += (uint64)Tmp[0].UW[1] + (uint64)Tmp[1].UW[1] + Tmp[2].UW[1]; */
	/* [hi] += ecx + edi + edx */
	
	AddX86regToVariable(&RecompPos, x86_ECX, &HI.UW[0], "HI.UW[0]");
	AdcConstToVariable(&RecompPos, &HI.UW[1], "HI.UW[1]", 0);

	AddX86regToVariable(&RecompPos, x86_EDI, &HI.UW[0], "HI.UW[0]");
	AdcConstToVariable(&RecompPos, &HI.UW[1], "HI.UW[1]", 0);

	AddX86regToVariable(&RecompPos, x86_EDX, &HI.UW[0], "HI.UW[0]");
	AdcConstToVariable(&RecompPos, &HI.UW[1], "HI.UW[1]", 0);
}
...
void Compile_R4300i_SPECIAL_DDIV (BLOCK_SECTION * Section) {
	...
	Pushad(&RecompPos);
	MoveConstToVariable(&RecompPos, Opcode.Hex, &Opcode.Hex, "Opcode.Hex" );
	Call_Direct(&RecompPos, (void*)r4300i_SPECIAL_DDIV, "r4300i_SPECIAL_DDIV");
	Popad(&RecompPos);
}
...
void Compile_R4300i_SPECIAL_DDIVU (BLOCK_SECTION * Section) {
	...
	Pushad(&RecompPos);
	MoveConstToVariable(&RecompPos, Opcode.Hex, &Opcode.Hex, "Opcode.Hex" );
	Call_Direct(&RecompPos, (void*)r4300i_SPECIAL_DDIVU, "r4300i_SPECIAL_DDIVU");
	Popad(&RecompPos);
}
...
void Compile_R4300i_SPECIAL_ADD (BLOCK_SECTION * Section) {
	...
	if (IsConst(source2)) {
		if (MipsRegLo(source2) != 0) {
			AddConstToX86Reg(&RecompPos, MipsRegLo(Opcode.REG.rd),MipsRegLo(source2));
		}
	} else if (IsKnown(source2) && IsMapped(source2)) {
		AddX86RegToX86Reg(&RecompPos, MipsRegLo(Opcode.REG.rd),MipsRegLo(source2));
	} else {
		AddVariableToX86reg(&RecompPos, MipsRegLo(Opcode.REG.rd),&GPR[source2].W[0],GPR_NameLo[source2]);
	}
}
...
void Compile_R4300i_SPECIAL_SUB (BLOCK_SECTION * Section) {
	...
	if (IsConst(Opcode.BRANCH.rt)  && IsConst(Opcode.BRANCH.rs)) {
		...
		if (Opcode.REG.rd == Opcode.BRANCH.rt) {
			...
			SubX86RegToX86Reg(&RecompPos, MipsRegLo(Opcode.REG.rd),x86Reg);
			return;
		}
		Map_GPR_32bit(Section,Opcode.REG.rd,TRUE, Opcode.BRANCH.rs);
		if (IsConst(Opcode.BRANCH.rt)) {
			SubConstFromX86Reg(&RecompPos, MipsRegLo(Opcode.REG.rd),MipsRegLo(Opcode.BRANCH.rt));
		} else if (IsMapped(Opcode.BRANCH.rt)) {
			SubX86RegToX86Reg(&RecompPos, MipsRegLo(Opcode.REG.rd),MipsRegLo(Opcode.BRANCH.rt));
		} else {
			SubVariableFromX86reg(&RecompPos, MipsRegLo(Opcode.REG.rd),&GPR[Opcode.BRANCH.rt].W[0],GPR_NameLo[Opcode.BRANCH.rt]);
		}
	}
}
	...
	if (IsKnown(Opcode.BRANCH.rt) && IsKnown(Opcode.BRANCH.rs)) {
		if (IsConst(Opcode.BRANCH.rt) && IsConst(Opcode.BRANCH.rs)) {
			...
			if (Is32Bit(source1) && Is32Bit(source2)) {
				...
				AndX86RegToX86Reg(&RecompPos, MipsRegLo(Opcode.REG.rd),MipsRegLo(source2));
				...
				if (IsUnsigned(Is32Bit(source1)?source1:source2)) {
					...
					if (Is32Bit(source2)) {
						AndX86RegToX86Reg(&RecompPos, MipsRegHi(Opcode.REG.rd),Map_TempReg(Section,x86_Any,source2,TRUE));
					} else {
						AndX86RegToX86Reg(&RecompPos, MipsRegHi(Opcode.REG.rd),MipsRegHi(source2));
					}
					AndX86RegToX86Reg(&RecompPos, MipsRegLo(Opcode.REG.rd),MipsRegLo(source2));
				}
			} else {
			...
			if (Is64Bit(ConstReg)) {
				if (Is32Bit(MappedReg) && IsUnsigned(MappedReg)) {
					if (MipsRegLo(ConstReg) == 0) {
						...
						AndConstToX86Reg(&RecompPos, MipsRegLo(Opcode.REG.rd),Value);
					}
				} else {
					_int64 Value = MipsReg(ConstReg);
					Map_GPR_64bit(Section,Opcode.REG.rd,MappedReg);
					AndConstToX86Reg(&RecompPos, MipsRegHi(Opcode.REG.rd),(DWORD)(Value >> 32));
					AndConstToX86Reg(&RecompPos, MipsRegLo(Opcode.REG.rd),(DWORD)Value);
				}
		...
		if (IsConst(KnownReg)) {
			...
			if (KnownReg == Opcode.REG.rd) {
				if (Is64Bit(KnownReg)) {
					...
					AndVariableToX86Reg(&RecompPos, &GPR[UnknownReg].W[1],GPR_NameHi[UnknownReg],MipsRegHi(Opcode.REG.rd));
					AndVariableToX86Reg(&RecompPos, &GPR[UnknownReg].W[0],GPR_NameLo[UnknownReg],MipsRegLo(Opcode.REG.rd));
				} else {
				...
				if (Is64Bit(KnownReg)) {
					Map_GPR_64bit(Section,Opcode.REG.rd,UnknownReg);
					AndX86RegToX86Reg(&RecompPos, MipsRegHi(Opcode.REG.rd),MipsRegHi(KnownReg));
					AndX86RegToX86Reg(&RecompPos, MipsRegLo(Opcode.REG.rd),MipsRegLo(KnownReg));
				} else {
					Map_GPR_32bit(Section,Opcode.REG.rd,IsSigned(KnownReg),UnknownReg);
					AndX86RegToX86Reg(&RecompPos, MipsRegLo(Opcode.REG.rd),MipsRegLo(KnownReg));
				}
		...
		Map_GPR_64bit(Section,Opcode.REG.rd,Opcode.BRANCH.rt);
		AndVariableToX86Reg(&RecompPos, &GPR[Opcode.BRANCH.rs].W[1],GPR_NameHi[Opcode.BRANCH.rs],MipsRegHi(Opcode.REG.rd));
		AndVariableToX86Reg(&RecompPos, &GPR[Opcode.BRANCH.rs].W[0],GPR_NameLo[Opcode.BRANCH.rs],MipsRegLo(Opcode.REG.rd));
	}
}
	...
	if (IsKnown(Opcode.BRANCH.rt) && IsKnown(Opcode.BRANCH.rs)) {
		if (IsConst(Opcode.BRANCH.rt) && IsConst(Opcode.BRANCH.rs)) {
			...
			if (Is64Bit(Opcode.BRANCH.rt) || Is64Bit(Opcode.BRANCH.rs)) {
				Map_GPR_64bit(Section,Opcode.REG.rd,source1);
				if (Is64Bit(source2)) {
					OrX86RegToX86Reg(&RecompPos, MipsRegHi(Opcode.REG.rd),MipsRegHi(source2));
				} else {
					OrX86RegToX86Reg(&RecompPos, MipsRegHi(Opcode.REG.rd),Map_TempReg(Section,x86_Any,source2,TRUE));
				}
			} else {
				ProtectGPR(Section,source2);
				Map_GPR_32bit(Section,Opcode.REG.rd,TRUE,source1);
			}
			OrX86RegToX86Reg(&RecompPos, MipsRegLo(Opcode.REG.rd),MipsRegLo(source2));
		} else {
			DWORD ConstReg = IsConst(Opcode.BRANCH.rt)?Opcode.BRANCH.rt:Opcode.BRANCH.rs;
			DWORD MappedReg = IsConst(Opcode.BRANCH.rt)?Opcode.BRANCH.rs:Opcode.BRANCH.rt;
			...
			if (Is64Bit(Opcode.BRANCH.rt) || Is64Bit(Opcode.BRANCH.rs)) {
				...
				Map_GPR_64bit(Section,Opcode.REG.rd,MappedReg);
				if ((Value >> 32) != 0) {
					OrConstToX86Reg(&RecompPos, (DWORD)(Value >> 32),MipsRegHi(Opcode.REG.rd));
				}
				if ((DWORD)Value != 0) {
					OrConstToX86Reg(&RecompPos, (DWORD)Value,MipsRegLo(Opcode.REG.rd));
				}
			} else {
				int Value = MipsRegLo(ConstReg);
				Map_GPR_32bit(Section,Opcode.REG.rd,TRUE, MappedReg);
				if (Value != 0) { OrConstToX86Reg(&RecompPos, Value,MipsRegLo(Opcode.REG.rd)); }
			}
		}
	} else if (IsKnown(Opcode.BRANCH.rt) || IsKnown(Opcode.BRANCH.rs)) {
		...
		if (IsConst(KnownReg)) {
			...
			Map_GPR_64bit(Section,Opcode.REG.rd,KnownReg);
			OrVariableToX86Reg(&RecompPos, &GPR[UnknownReg].W[1],GPR_NameHi[UnknownReg],MipsRegHi(Opcode.REG.rd));
			OrVariableToX86Reg(&RecompPos, &GPR[UnknownReg].W[0],GPR_NameLo[UnknownReg],MipsRegLo(Opcode.REG.rd));
		}
	} else {
		Map_GPR_64bit(Section,Opcode.REG.rd,Opcode.BRANCH.rt);
		OrVariableToX86Reg(&RecompPos, &GPR[Opcode.BRANCH.rs].W[1],GPR_NameHi[Opcode.BRANCH.rs],MipsRegHi(Opcode.REG.rd));
		OrVariableToX86Reg(&RecompPos, &GPR[Opcode.BRANCH.rs].W[0],GPR_NameLo[Opcode.BRANCH.rs],MipsRegLo(Opcode.REG.rd));
	}
	...
	if (IsKnown(Opcode.BRANCH.rt) && IsKnown(Opcode.BRANCH.rs)) {
		if (IsConst(Opcode.BRANCH.rt) && IsConst(Opcode.BRANCH.rs)) {
			...
			if (Is64Bit(Opcode.BRANCH.rt) || Is64Bit(Opcode.BRANCH.rs)) {
				Map_GPR_64bit(Section,Opcode.REG.rd,source1);
				if (Is64Bit(source2)) {
					XorX86RegToX86Reg(&RecompPos, MipsRegHi(Opcode.REG.rd),MipsRegHi(source2));
				} else if (IsSigned(source2)) {
					XorX86RegToX86Reg(&RecompPos, MipsRegHi(Opcode.REG.rd),Map_TempReg(Section,x86_Any,source2,TRUE));
				}
				XorX86RegToX86Reg(&RecompPos, MipsRegLo(Opcode.REG.rd),MipsRegLo(source2));
			} else {
			...
			if (Is64Bit(Opcode.BRANCH.rt) || Is64Bit(Opcode.BRANCH.rs)) {
				...
				Map_GPR_64bit(Section,Opcode.REG.rd,MappedReg);
				if (ConstHi != 0) { XorConstToX86Reg(&RecompPos, MipsRegHi(Opcode.REG.rd),ConstHi); }
				if (ConstLo != 0) { XorConstToX86Reg(&RecompPos, MipsRegLo(Opcode.REG.rd),ConstLo); }
			} else {
				int Value = MipsRegLo(ConstReg);
				if (IsSigned(Opcode.BRANCH.rt) != IsSigned(Opcode.BRANCH.rs)) {
					Map_GPR_32bit(Section,Opcode.REG.rd,TRUE, MappedReg);
				...
				if (Value != 0) { XorConstToX86Reg(&RecompPos, MipsRegLo(Opcode.REG.rd),Value); }
			}
		}
	} else if (IsKnown(Opcode.BRANCH.rt) || IsKnown(Opcode.BRANCH.rs)) {
		int KnownReg = IsKnown(Opcode.BRANCH.rt)?Opcode.BRANCH.rt:Opcode.BRANCH.rs;
		...
		if (IsConst(KnownReg)) {
			...
			Map_GPR_64bit(Section,Opcode.REG.rd,UnknownReg);
			if ((Value >> 32) != 0) {
				XorConstToX86Reg(&RecompPos, MipsRegHi(Opcode.REG.rd),(DWORD)(Value >> 32));
			}
			if ((DWORD)Value != 0) {
				XorConstToX86Reg(&RecompPos, MipsRegLo(Opcode.REG.rd),(DWORD)Value);
			}
		} else {
			Map_GPR_64bit(Section,Opcode.REG.rd,KnownReg);
			XorVariableToX86reg(&RecompPos, &GPR[UnknownReg].W[1],GPR_NameHi[UnknownReg],MipsRegHi(Opcode.REG.rd));
			XorVariableToX86reg(&RecompPos, &GPR[UnknownReg].W[0],GPR_NameLo[UnknownReg],MipsRegLo(Opcode.REG.rd));
		}
	} else {
		Map_GPR_64bit(Section,Opcode.REG.rd,Opcode.BRANCH.rt);
		XorVariableToX86reg(&RecompPos, &GPR[Opcode.BRANCH.rs].W[1],GPR_NameHi[Opcode.BRANCH.rs],MipsRegHi(Opcode.REG.rd));
		XorVariableToX86reg(&RecompPos, &GPR[Opcode.BRANCH.rs].W[0],GPR_NameLo[Opcode.BRANCH.rs],MipsRegLo(Opcode.REG.rd));
	}
}
	...
	if (IsKnown(Opcode.BRANCH.rt) && IsKnown(Opcode.BRANCH.rs)) {
		if (IsConst(Opcode.BRANCH.rt) && IsConst(Opcode.BRANCH.rs)) {
			...
			if (Is64Bit(Opcode.BRANCH.rt) || Is64Bit(Opcode.BRANCH.rs)) {
				...
				OrX86RegToX86Reg(&RecompPos, MipsRegLo(Opcode.REG.rd),MipsRegLo(source2));
				NotX86Reg(&RecompPos, MipsRegHi(Opcode.REG.rd));
				NotX86Reg(&RecompPos, MipsRegLo(Opcode.REG.rd));
			} else {
				ProtectGPR(Section,source2);
				if (IsSigned(Opcode.BRANCH.rt) != IsSigned(Opcode.BRANCH.rs)) {
					Map_GPR_32bit(Section,Opcode.REG.rd,TRUE,source1);
	...
	if (IsKnown(Opcode.BRANCH.rt) && IsKnown(Opcode.BRANCH.rs)) {
		if (IsConst(Opcode.BRANCH.rt) && IsConst(Opcode.BRANCH.rs)) {
			...
			if (Is64Bit(Opcode.BRANCH.rt) || Is64Bit(Opcode.BRANCH.rs)) {
				...
				*((BYTE *)(Jump[1]))=(BYTE)(RecompPos - Jump[1] - 1);
				Map_GPR_32bit(Section,Opcode.REG.rd,TRUE, -1);
				MoveVariableToX86reg(&RecompPos, &BranchCompare,"BranchCompare",MipsRegLo(Opcode.REG.rd));
			} else {
				Map_GPR_32bit(Section,Opcode.REG.rd,TRUE, -1);
				CompX86RegToX86Reg(&RecompPos, MipsRegLo(Opcode.BRANCH.rs), MipsRegLo(Opcode.BRANCH.rt));
				...
				if (MipsRegLo(Opcode.REG.rd) > x86_EDX) {
					...
					Setl(&RecompPos, MipsRegLo(Opcode.REG.rd));
					AndConstToX86Reg(&RecompPos, MipsRegLo(Opcode.REG.rd), 1);
				}
			}
		} else {
			...
			if (Is64Bit(Opcode.BRANCH.rt) || Is64Bit(Opcode.BRANCH.rs)) {
				...
				if (MappedReg == Opcode.BRANCH.rs) {
					...
					SetgVariable(&RecompPos, &BranchCompare,"BranchCompare");
				}
				JmpLabel8(&RecompPos, "Continue",0);
				Jump[1] = RecompPos - 1;
				...
				*((BYTE *)(Jump[0]))=(BYTE)(RecompPos - Jump[0] - 1);
				...
				if (MappedReg == Opcode.BRANCH.rs) {
					...
					SetaVariable(&RecompPos, &BranchCompare,"BranchCompare");
				}
				CPU_Message("");
				CPU_Message("      Continue:");
				*((BYTE *)(Jump[1]))=(BYTE)(RecompPos - Jump[1] - 1);
				...
				Map_GPR_32bit(Section,Opcode.REG.rd,TRUE, -1);
				CompConstToX86reg(&RecompPos, MipsRegLo(MappedReg), Constant);
				...
				if (MipsRegLo(Opcode.REG.rd) > x86_EDX) {
					...
					if (MappedReg == Opcode.BRANCH.rs) {
						...
						Setg(&RecompPos, MipsRegLo(Opcode.REG.rd));
					}
					AndConstToX86Reg(&RecompPos, MipsRegLo(Opcode.REG.rd), 1);
				}
			}
	...
	if (IsKnown(Opcode.BRANCH.rt) && IsKnown(Opcode.BRANCH.rs)) {
		if (IsConst(Opcode.BRANCH.rt) && IsConst(Opcode.BRANCH.rs)) {
			...
			if (Is64Bit(Opcode.BRANCH.rt) || Is64Bit(Opcode.BRANCH.rs)) {
				...
				Map_GPR_32bit(Section,Opcode.REG.rd,TRUE, -1);
				CompConstToX86reg(&RecompPos, MappedRegHi, ConstHi);
				JeLabel8(&RecompPos, "Low Compare",0);
				Jump[0] = RecompPos - 1;
				if (MappedReg == Opcode.BRANCH.rs) {
					SetbVariable(&RecompPos, &BranchCompare,"BranchCompare");
				...
				CPU_Message("      Low Compare:");
				*((BYTE *)(Jump[0]))=(BYTE)(RecompPos - Jump[0] - 1);
				CompConstToX86reg(&RecompPos, MappedRegLo, ConstLo);
				if (MappedReg == Opcode.BRANCH.rs) {
					SetbVariable(&RecompPos, &BranchCompare,"BranchCompare");
				} else {
					SetaVariable(&RecompPos, &BranchCompare,"BranchCompare");
				...
				*((BYTE *)(Jump[1]))=(BYTE)(RecompPos - Jump[1] - 1);
				...
				CompConstToX86reg(&RecompPos, MipsRegLo(MappedReg), Const);
				if (MappedReg == Opcode.BRANCH.rs) {
					SetbVariable(&RecompPos, &BranchCompare,"BranchCompare");
				} else {
					SetaVariable(&RecompPos, &BranchCompare,"BranchCompare");
...
void Compile_R4300i_SPECIAL_DADD (BLOCK_SECTION * Section) {
	...
	if (IsConst(Opcode.BRANCH.rt)  && IsConst(Opcode.BRANCH.rs)) {
		...
		if (IsConst(Opcode.BRANCH.rt)) {
			AddConstToX86Reg(&RecompPos, MipsRegLo(Opcode.REG.rd),MipsRegLo(Opcode.BRANCH.rt));
			AddConstToX86Reg(&RecompPos, MipsRegHi(Opcode.REG.rd),MipsRegHi(Opcode.BRANCH.rt));
		} else if (IsMapped(Opcode.BRANCH.rt)) {
			...
			AddX86RegToX86Reg(&RecompPos, MipsRegLo(Opcode.REG.rd),MipsRegLo(Opcode.BRANCH.rt));
			AdcX86RegToX86Reg(&RecompPos, MipsRegHi(Opcode.REG.rd),HiReg);
		} else {
			AddVariableToX86reg(&RecompPos, MipsRegLo(Opcode.REG.rd),&GPR[Opcode.BRANCH.rt].W[0],GPR_NameLo[Opcode.BRANCH.rt]);
			AdcVariableToX86reg(&RecompPos, MipsRegHi(Opcode.REG.rd),&GPR[Opcode.BRANCH.rt].W[1],GPR_NameHi[Opcode.BRANCH.rt]);
		}
	}
}
...
void Compile_R4300i_SPECIAL_DSUB (BLOCK_SECTION * Section) {
	...
	if (IsConst(Opcode.BRANCH.rt)  && IsConst(Opcode.BRANCH.rs)) {
		...
		if (Opcode.REG.rd == Opcode.BRANCH.rt) {
			...
			Map_GPR_64bit(Section,Opcode.REG.rd,Opcode.BRANCH.rs);
			SubX86RegToX86Reg(&RecompPos, MipsRegLo(Opcode.REG.rd),LoReg);
			SbbX86RegToX86Reg(&RecompPos, MipsRegHi(Opcode.REG.rd),HiReg);
			return;
		}
		Map_GPR_64bit(Section,Opcode.REG.rd,Opcode.BRANCH.rs);
		if (IsConst(Opcode.BRANCH.rt)) {
			SubConstFromX86Reg(&RecompPos, MipsRegLo(Opcode.REG.rd),MipsRegLo(Opcode.BRANCH.rt));
			SbbConstFromX86Reg(&RecompPos, MipsRegHi(Opcode.REG.rd),MipsRegHi(Opcode.BRANCH.rt));
		} else if (IsMapped(Opcode.BRANCH.rt)) {
			ProtectGPR(Section, Opcode.REG.rd);
			int HiReg = Is64Bit(Opcode.BRANCH.rt)?MipsRegHi(Opcode.BRANCH.rt):Map_TempReg(Section,x86_Any,Opcode.BRANCH.rt,TRUE);
			SubX86RegToX86Reg(&RecompPos, MipsRegLo(Opcode.REG.rd),MipsRegLo(Opcode.BRANCH.rt));
			...
			SubVariableFromX86reg(&RecompPos, MipsRegLo(Opcode.REG.rd),&GPR[Opcode.BRANCH.rt].W[0],GPR_NameLo[Opcode.BRANCH.rt]);
			SbbVariableFromX86reg(&RecompPos, MipsRegHi(Opcode.REG.rd),&GPR[Opcode.BRANCH.rt].W[1],GPR_NameHi[Opcode.BRANCH.rt]);
		}
	}
}
...
void Compile_R4300i_SPECIAL_DSLL (BLOCK_SECTION * Section) {
	...
	Map_GPR_64bit(Section,Opcode.REG.rd,Opcode.BRANCH.rt);
	ShiftLeftDoubleImmed(&RecompPos, MipsRegHi(Opcode.REG.rd),MipsRegLo(Opcode.REG.rd),(BYTE)Opcode.REG.sa);
	ShiftLeftSignImmed(&RecompPos, MipsRegLo(Opcode.REG.rd),(BYTE)Opcode.REG.sa);
}
...
void Compile_R4300i_SPECIAL_DSRL (BLOCK_SECTION * Section) {
	...
	Map_GPR_64bit(Section,Opcode.REG.rd,Opcode.BRANCH.rt);
	ShiftRightDoubleImmed(&RecompPos, MipsRegLo(Opcode.REG.rd),MipsRegHi(Opcode.REG.rd),(BYTE)Opcode.REG.sa);
	ShiftRightUnsignImmed(&RecompPos, MipsRegHi(Opcode.REG.rd),(BYTE)Opcode.REG.sa);
}
...
void Compile_R4300i_SPECIAL_DSRA (BLOCK_SECTION * Section) {
	...
	Map_GPR_64bit(Section,Opcode.REG.rd,Opcode.BRANCH.rt);
	ShiftRightDoubleImmed(&RecompPos, MipsRegLo(Opcode.REG.rd),MipsRegHi(Opcode.REG.rd),(BYTE)Opcode.REG.sa);
	ShiftRightSignImmed(&RecompPos, MipsRegHi(Opcode.REG.rd),(BYTE)Opcode.REG.sa);
}
...
void Compile_R4300i_SPECIAL_DSLL32 (BLOCK_SECTION * Section) {
	...
	if (IsConst(Opcode.BRANCH.rt)) {
		...
		if (Opcode.BRANCH.rt != Opcode.REG.rd) {
			MoveX86RegToX86Reg(&RecompPos, MipsRegLo(Opcode.BRANCH.rt),MipsRegHi(Opcode.REG.rd));
		} else {
		...
		if ((BYTE)Opcode.REG.sa != 0) {
			ShiftLeftSignImmed(&RecompPos, MipsRegHi(Opcode.REG.rd),(BYTE)Opcode.REG.sa);
		}
		XorX86RegToX86Reg(&RecompPos, MipsRegLo(Opcode.REG.rd),MipsRegLo(Opcode.REG.rd));
	} else {
		ProtectGPR(Section, Opcode.BRANCH.rt);
		Map_GPR_64bit(Section,Opcode.REG.rd,-1);
		MoveVariableToX86reg(&RecompPos, &GPR[Opcode.BRANCH.rt],GPR_NameHi[Opcode.BRANCH.rt],MipsRegHi(Opcode.REG.rd));
		if ((BYTE)Opcode.REG.sa != 0) {
			ShiftLeftSignImmed(&RecompPos, MipsRegHi(Opcode.REG.rd),(BYTE)Opcode.REG.sa);
		}
		XorX86RegToX86Reg(&RecompPos, MipsRegLo(Opcode.REG.rd),MipsRegLo(Opcode.REG.rd));
	...
	if (IsConst(Opcode.BRANCH.rt)) {
		...
		if (Is64Bit(Opcode.BRANCH.rt)) {
			if (Opcode.BRANCH.rt == Opcode.REG.rd) {
				...
				Map_GPR_32bit(Section,Opcode.REG.rd,FALSE,-1);
				MoveX86RegToX86Reg(&RecompPos, MipsRegHi(Opcode.BRANCH.rt),MipsRegLo(Opcode.REG.rd));
			}
			if ((BYTE)Opcode.REG.sa != 0) {
				ShiftRightUnsignImmed(&RecompPos, MipsRegLo(Opcode.REG.rd),(BYTE)Opcode.REG.sa);
			}
		...
		ProtectGPR(Section, Opcode.BRANCH.rt);
		Map_GPR_32bit(Section,Opcode.REG.rd,FALSE,-1);
		MoveVariableToX86reg(&RecompPos, &GPR[Opcode.BRANCH.rt].UW[1],GPR_NameLo[Opcode.BRANCH.rt],MipsRegLo(Opcode.REG.rd));
		if ((BYTE)Opcode.REG.sa != 0) {
			ShiftRightUnsignImmed(&RecompPos, MipsRegLo(Opcode.REG.rd),(BYTE)Opcode.REG.sa);
		}
	}
...
void Compile_R4300i_COP0_MF(BLOCK_SECTION * Section) {
	...
	ProtectGPR(Section, Opcode.REG.rd);
	Map_GPR_32bit(Section,Opcode.BRANCH.rt,TRUE,-1);
	MoveVariableToX86reg(&RecompPos, &CP0[Opcode.REG.rd],Cop0_Name[Opcode.REG.rd],MipsRegLo(Opcode.BRANCH.rt));
}
...
void Compile_R4300i_COP0_DMF(BLOCK_SECTION * Section) {
	...
	Map_GPR_64bit(Section, Opcode.BRANCH.rt, -1);
	MoveVariableToX86reg(&RecompPos, &CP0[Opcode.REG.rd], Cop0_Name[Opcode.REG.rd], MipsRegLo(Opcode.BRANCH.rt));
	MoveX86RegToX86Reg(&RecompPos, MipsRegLo(Opcode.BRANCH.rt), MipsRegHi(Opcode.BRANCH.rt));
	ShiftRightSignImmed(&RecompPos, MipsRegHi(Opcode.BRANCH.rt), 31);
}
...
void Compile_R4300i_COP0_MT (BLOCK_SECTION * Section) {
	...
	case 30: //ErrEPC
		if (IsConst(Opcode.BRANCH.rt)) {
			MoveConstToVariable(&RecompPos, MipsRegLo(Opcode.BRANCH.rt), &CP0[Opcode.REG.rd], Cop0_Name[Opcode.REG.rd]);
		} else if (IsMapped(Opcode.BRANCH.rt)) {
			MoveX86regToVariable(&RecompPos, MipsRegLo(Opcode.BRANCH.rt), &CP0[Opcode.REG.rd], Cop0_Name[Opcode.REG.rd]);
		} else {
			MoveX86regToVariable(&RecompPos, Map_TempReg(Section,x86_Any,Opcode.BRANCH.rt,FALSE), &CP0[Opcode.REG.rd], Cop0_Name[Opcode.REG.rd]);
		}
		switch (Opcode.REG.rd) {
		case 4: //Context
			AndConstToVariable(&RecompPos, 0xFF800000,&CP0[Opcode.REG.rd], Cop0_Name[Opcode.REG.rd]);
			break;			
		case 9: //Count
			BlockCycleCount = 0;
			Pushad(&RecompPos);
			Call_Direct(&RecompPos, (void*)ChangeCompareTimer,"ChangeCompareTimer");
			Popad(&RecompPos);
			break;
		case 11: //Compare
			AddConstToVariable(&RecompPos, BlockCycleCount,&CP0[9],Cop0_Name[9]);
			SubConstFromVariable(&RecompPos, BlockCycleCount,&Timers.Timer,"Timer");
			BlockCycleCount = 0;
			AndConstToVariable(&RecompPos, (DWORD)~CAUSE_IP7,&CAUSE_REGISTER,"CAUSE_REGISTER");
			Pushad(&RecompPos);
			Call_Direct(&RecompPos, (void*)ChangeCompareTimer,"ChangeCompareTimer");
			Popad(&RecompPos);
		}
	...
	case 12: //Status
		...
		MoveVariableToX86reg(&RecompPos, &CP0[Opcode.REG.rd],Cop0_Name[Opcode.REG.rd],OldStatusReg);
		if (IsConst(Opcode.BRANCH.rt)) {
			MoveConstToVariable(&RecompPos, MipsRegLo(Opcode.BRANCH.rt), &CP0[Opcode.REG.rd], Cop0_Name[Opcode.REG.rd]);
		} else if (IsMapped(Opcode.BRANCH.rt)) {
			MoveX86regToVariable(&RecompPos, MipsRegLo(Opcode.BRANCH.rt), &CP0[Opcode.REG.rd], Cop0_Name[Opcode.REG.rd]);
		...
		XorVariableToX86reg(&RecompPos, &CP0[Opcode.REG.rd], Cop0_Name[Opcode.REG.rd],OldStatusReg);
		TestConstToX86Reg(&RecompPos, STATUS_FR,OldStatusReg);
		JeLabel8(&RecompPos, "FpuFlagFine",0);
		Jump = RecompPos - 1;
		Pushad(&RecompPos);
		Call_Direct(&RecompPos, (void*)SetFpuLocations,"SetFpuLocations");
		Popad(&RecompPos);
		*(BYTE *)(Jump)= (BYTE )(((DWORD)(RecompPos)) - (((DWORD)(Jump)) + 1));
	...
	case 6: //Wired
		...
		Call_Direct(&RecompPos, (void*)FixRandomReg,"FixRandomReg");
		Popad(&RecompPos);
		if (IsConst(Opcode.BRANCH.rt)) {
			MoveConstToVariable(&RecompPos, MipsRegLo(Opcode.BRANCH.rt), &CP0[Opcode.REG.rd], Cop0_Name[Opcode.REG.rd]);
		} else if (IsMapped(Opcode.BRANCH.rt)) {
		...
		break;
	case 13: //cause
		AndConstToVariable(&RecompPos, 0xFFFFCFF, &CP0[Opcode.REG.rd], Cop0_Name[Opcode.REG.rd]);
...
void Compile_R4300i_COP0_CO_TLBR( BLOCK_SECTION * Section) {
	...
	if (!UseTlb) {	return; }
	Pushad(&RecompPos);
	Call_Direct(&RecompPos, (void*)TLB_Read,"TLB_Read");
	Popad(&RecompPos);
}
...
void Compile_R4300i_COP0_CO_TLBWI( BLOCK_SECTION * Section) {
	...
	if (!UseTlb) {	return; }
	Pushad(&RecompPos);
	MoveVariableToX86reg(&RecompPos, &INDEX_REGISTER,"INDEX_REGISTER",x86_ECX);
	AndConstToX86Reg(&RecompPos, x86_ECX,0x1F);
	Call_Direct(&RecompPos, (void*)WriteTLBEntry,"WriteTLBEntry");
	Popad(&RecompPos);
}
...
void Compile_R4300i_COP0_CO_TLBWR( BLOCK_SECTION * Section) {
	...
	Pushad(&RecompPos);
	Call_Direct(&RecompPos, (void*)FixRandomReg,"FixRandomReg");
	MoveVariableToX86reg(&RecompPos, &RANDOM_REGISTER,"RANDOM_REGISTER",x86_ECX);
	AndConstToX86Reg(&RecompPos, x86_ECX,0x1F);
	Call_Direct(&RecompPos, (void*)WriteTLBEntry,"WriteTLBEntry");
	Popad(&RecompPos);
}
...
void Compile_R4300i_COP0_CO_TLBP( BLOCK_SECTION * Section) {
	...
	if (!UseTlb) {	return; }
	Pushad(&RecompPos);
	Call_Direct(&RecompPos, (void*)TLB_Probe,"TLB_Probe");
	Popad(&RecompPos);
}
...
void Compile_R4300i_COP0_CO_ERET( BLOCK_SECTION * Section) {
	...
	WriteBackRegisters(Section);
	Call_Direct(&RecompPos, (void*)compiler_COP0_CO_ERET,"compiler_COP0_CO_ERET");
	CompileExit((DWORD)-1,Section->RegWorking,Normal,TRUE,NULL);
	NextInstruction = END_BLOCK;
}
