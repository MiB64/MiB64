...
void BuildInterpreterRspCPU(void) {
	...
	RSP_RegImm[16] = /*RSP_Opcode_BLTZAL*/(void*)rsp_UnknownOpcode;
	RSP_RegImm[17] = /*RSP_Opcode_BGEZAL*/(void*)rsp_UnknownOpcode;
	...
	RSP_Cop2[31] = /*(void*)RSP_COP2_VECTOR*/(void*)rsp_UnknownOpcode;
